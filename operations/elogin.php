...
<body onLoad="document.login.userid.focus();" leftmargin="0" topmargin="0">



<script>
document.title= '<? echo $company_name . " ERP - Umrah Operations Login"; ?>';
</script>

<table width="100%" >
  <tr>
    <td><div align="center"><img src="../images/logo.jpg" width="56" height="56"></div></td>
  </tr>
  <tr>
...
<table width="100%"><tr><td><center>
	   ...
	   <form name="login" action="logina.php" method="post" onSubmit="return val(this)">
               ...
               <tr>
                  <td colspan="2"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><font color="#FF0000" size="4" face="Arial, Helvetica, sans-serif">Welcome
                        to Operations</font></font></div></td>
                </tr>
                   <tr>
