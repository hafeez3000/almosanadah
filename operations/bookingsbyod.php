...
<script>
document.title= '<? echo $company_name . " ERP - Groups by Order Date"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      are here: <a href="uhome.php">Home</a> &raquo; Group Operations</a> &raquo; Groups by Order Date</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Groups by Order Date</strong></td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0"><tr>
                      <td> 
                          <table width="100%" border="0" cellspacing="0" style=" border-bottom: 1px solid #999999">
                          <form name="bbyod" method="post" action="bbyodaction.php">
                            <tr> 
	...
	?>
                            ...
                            <tr> 
                              <td colspan="2"><div align="right"> 
                                  <input type="submit" name="Submit" value="Find Groups by Order Date >>>">
                                </div></td>
                            </tr>
                          </form>
                        </table>
<br>
                        <table width="100%" border="0" cellspacing="0" style=" border-bottom: 1px solid #999999">
                          <form name="bbyod1" method="post" action="bbyodactiont.php" onSubmit="return fun2(this)">
                            ...
                            <tr> 
                              <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Enter 
                                  Text </font></div></td>
                              <td><input type="text" id="tdata" name="tdata" size="30"></td>
                            </tr>
                            <tr> 
                              <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Select 
                                  Text Type</font></div></td>
                              <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                                <font size="2" face="Arial, Helvetica, sans-serif"><strong> 
                            ...
                            <tr> 
                              <td colspan="2"><div align="right"> 
                                  <input type="submit" name="Submit" value="Find Groups by  >>>">
                                </div></td>
                            </tr>
                          </form>
                        </table>
