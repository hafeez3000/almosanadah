...
$s_tb = "Hotels";
$q_type_booking = $q_type_booking ." and sales_hotels='true'"; 
}
if($s_type_booking=="trans"){
$s_tb = "Transportation";
$q_type_booking = $q_type_booking ." and sales_trans='true'"; 
}
...
$s_tb = "Others/Extras";
$q_type_booking = $q_type_booking ." and sales_others='true'"; 
}
                      ...
                      <td> 
                         ...
                         <tr><td>
						  ...
						  <table width="100%" border="0" cellspacing="0">
							 <tr><td>
<?
$q_main_sel ="select main_sno,	ocode,user_sno,user_id,guest_name,order_date,option_date,booking_status,cus_company_name,cus_country,sales_hotels,sales_trans,sales_visa,sales_others from sales_main where order_date between '$from_date' and date '$to_date' + integer '1' and booking_status like '$s_booking_status' $q_type_booking $q_agentname order by order_date, guest_name";
...
echo "Search Results Between  <font color=\"#FF0000\">$from_date_re</font> and <font color=\"#FF0000\">$to_date_re</font> and  <font color=\"#FF0000\">";

if($s_booking_status=="%"){echo "All" ;} else { echo $s_booking_status;}

echo "</font> of <font color=\"#FF0000\">$s_tb</font>";	 


echo "</b></font></div></td></td></tr>" ;

echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>PNR</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Group Name</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Order Date</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>User Id</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Company</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Country</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Status</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Details</b></font></div></td></tr>";
}
