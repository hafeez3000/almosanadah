...
<script>
document.title= '<? echo $company_name . " ERP - Management Login"; ?>';
</script>
...
<table width="100%"><tr><td><center>
	   ...
	   <form name="login" action="logina.php" method="post" onSubmit="return val(this)">
	    <table width="100%" align="center" >
                <tr>
                  <td colspan="2"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><font color="#CC6633" size="4" face="Arial, Helvetica, sans-serif">Welcome
                        to Management</font></font></div></td>
                </tr>
                <tr>
