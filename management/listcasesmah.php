...
$my = $_POST['d1Year'];
 ...
 $tod = $my."-".$mm."-".$md;
				...
				$q_main_sel ="select sno,subject,date_entered,description,resolution,status,priority  from cases where date_entered between date '$fromd' and date '$tod' + integer '1' order by date_entered desc ";
...
if($suser_sno==1){
echo "<a href=\"caseresolution.php?caseno=$s_sno\" >";
echo $s_sno;
echo "</a>";
}
else {
