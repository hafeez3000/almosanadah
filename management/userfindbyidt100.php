...
$query_trans ="select user_sno,user_id,user_title,user_first_name,user_last_name,online_status,sr_status,umrah_status,operations_status,management_status,accounts_status,hrm_status from users order by reg_date desc limit '$hn' ";
