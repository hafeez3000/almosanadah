...
$query_trans ="select user_sno,user_id,user_title,user_first_name,user_last_name,online_status,sr_status,umrah_status,operations_status,management_status,accounts_status,hrm_status from users where lower(user_first_name) like '%$hn%' or lower(user_last_name) like '%$hn%' order by user_id";
...
echo "<tfoot style=\"display:table-footer-group;\"><tr><td colspan=\"11\" style=\"border-top: 1px solid #999999\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">End of the Page</font></td></tr></tfoot>";
echo "</table>";
