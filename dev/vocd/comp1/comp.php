...
$array_newacc = array();
$query_hotel ="select acccode,acc_name from accmast  where che_b=0 and acccode between '150000' and '151013' ORDER BY acc_name";
...
$query_hotel2 ="select aname,country,agentid from agentsdet  where newac=0  ORDER BY aname";
...
$array_acc_name[] = $rows_hotel2["aname"];
$array_acccode[] = $rows_hotel2["country"];
$array_uno[] = $rows_hotel2["agentid"];
