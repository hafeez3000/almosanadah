...
';
  ...
  function printChat( $return = false )
  {
    ...
    $output .= "<a href=\"http://www.phpfreechat.net\"><img src=\"http://www.phpfreechat.net/pub/logo_80x15.gif\" alt=\"DORS PHP FREE CHAT [powered by phpFreeChat-".$c->version."]\" title=\"DORS PHP FREE CHAT [powered by phpFreeChat-".$c->version."]\" /></a>";
    $output .= "</div>";
