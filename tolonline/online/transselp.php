...
grand_sell(grand_gt);
							...
							<? if($trans1sellr * $s_noofu0 > 0) { ?>
							<input type="text" id="trans1rate<? echo $s_typeoftrans0 ?>" name="trans1rate<? echo $s_typeoftrans0 ?>" value='<? echo $trans1sellr * $s_noofu0 ?>' size="2" onKeyUp="trans1<? echo $s_typeoftrans0 ?>()"  onFocus="trans1<? echo $s_typeoftrans0 ?>()" onBlur="trans1<? echo $s_typeoftrans0 ?>()" readonly>
...
<?php } else { ?>
<tr><td colspan="2" align="center" style="color:#FF0000">Sorry, the transportation you have selected is not available. Please select another one.</td></tr>
<tr><td colspan="2" align="center" style="color:#FF0000"><INPUT type="button" name="mybutton1" value="Select another Transportation" onClick="history.back()"></td></tr>
<?php } ?>
