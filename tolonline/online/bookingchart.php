...
<table width="100%" border="0" cellspacing="0">
							 <tr><td>
<?
$q_trans_sel ="select sales_trans_sno,req_date_time,f2t,type_of_trans,no_of_units,no_of_paxs,flight_det,sell_rate,tot_sell_rate  from sales_trans where ocode='NC' order by sales_trans_sno";
...
<table width="100%" border="0" cellspacing="0">
							 <tr><td>
<?
$q_visa_sel ="select sales_visa_sno,req_date_time,no_adults,no_child,no_infant,sell_adults,tot_sell_adults,tot_sell_child,tot_sell_infant from sales_visa where ocode='NC' order by sales_visa_sno";
...
<table width="100%" border="0" cellspacing="0">
							 <tr><td>
<?
$q_extra_sel ="select sales_extra_sno,req_date_time,paticulars,sell_rate from sales_extra where ocode='NC' order by sales_extra_sno";
