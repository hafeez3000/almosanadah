...
<table width="100%" cellpadding="1" cellspacing="0"><tr>
		  ...
		  <input type="hidden" name="u_account_code" id="u_account_code" value=<? echo $_SESSION['user_a_code'] ; ?> >
...
var u_a_c = document.getElementById("u_account_code").value;

showHint(fv, from_d, to_d, u_a_c);
