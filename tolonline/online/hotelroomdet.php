...
<script>
document.title= '<? echo $company_name . " ERP - Umrah New Booking - Select Room Type"; ?>';
</script>
...
if($s_hotelsmad == "select") { $s_hotelsmad=$_POST["hotelv"] ;}
...
<form name="gquot" action="hotelroomrate.php"  method="post" onSubmit="return checkval(this)">
                            ...
                            <td colspan="2">Select Hotel Room Type</td>
                                  ...
                                  <tr> 
                                    <td style="border-right: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Hotel 
									  ...
									  <?
									  $query_hotel ="select hotel_id, hotel_name,hotel_type, city from hotels where hotel_id='$s_hotelsmad'";
...
$hotel_type = $rows_hotel["hotel_type"];
...
//date('m', strtotime($madcin1)),date('d', strtotime($madcin1))+$madnit,date('Y', strtotime($madcin1))
...
echo "</select></td><td align=\"center\" style=\"border-right: 1px solid #999999; border-bottom: 1px solid #999999\"><select id=\"madmeals".$s_roid."[]"."\" name=\"madmeals".$s_roid."[]"."\" MULTIPLE SIZE=\"2\"><option value=\"meals\">Meals</option><option value=\"breakfast\">B/B</option><option value=\"halfboard\">H/B</option><option value=\"fullboard\">F/B</option><option value=\"sahoor\">Sahoor</option><option value=\"iftar\">Iftar</option></select></td>";
...
echo "<td align=\"center\" style=\"border-bottom: 1px solid #999999;\"><img src=\"../images/requ.jpg\" onClick=\"send_m$s_roid()\" ></td><td align=\"center\" style=\"border-right: 1px solid #999999; border-bottom: 1px solid #999999\">";
...
function send_m<? echo $s_roid ?>(){ 

var choices = document.getElementById ("madmeals<? echo $s_roid; ?>[]");
var r="";
for (var i=0; i < choices.options.length; i++){
if (choices.options[i].selected)
r = r + " " + choices.options[i].value  ;
}

var meals = r;

//	var nofrjs = document.getElementById ('madrooms<? echo $s_roid; ?>').value;
	window.open('sendrreq.php?roomid=<? echo $s_roid; ?>&madcin=<? echo $madcin; ?>&madcout=<? echo $madcout; ?>&hotel=<? echo $hotel_name_dis . " - " . $hotel_city; ?>&nofr='+document.getElementById ("madrooms<? echo $s_roid; ?>").value+'&nofp='+document.getElementById ("madpaxs<? echo $s_roid; ?>").value+'&madmeals='+meals, '<? echo $s_roid; ?>' ,  'width=700,height=400,scrollbars=yes,top='+wint+',left='+winl+' ').focus() ; 
...
if(chks.length==0){
alert("Rooms are Not Available for online booking please Request by Email");
return false;
}
else {
