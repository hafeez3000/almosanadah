...
<script>
document.title= '<? echo $company_name . " ERP - Umrah - Group Rates Entry"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      ...
      &raquo; GroupRates Entry</font></td>
  </tr></table>
...
echo " <a href=\"amdgrperiod.php?cin=$arr_from_dates1[$ad]&cout=$arr_to_dates1[$ad]&hot=$s_hotelsb&nat=$arr_nationality_s[$an]\">Amend Period</a>&nbsp; <a href=\"delgrperiod.php?cin=$arr_from_dates1[$ad]&cout=$arr_to_dates1[$ad]&hot=$s_hotelsb&nat=$arr_nationality_s[$an]\">Delete Period</a></font></div></td></tr>";
...
echo "<a href=\"amdgrperiodvt.php?cin=$arr_from_dates1[$ad]&cout=$arr_to_dates1[$ad]&hot=$s_hotelsb&viewt=$arr_view_type[$av]&nat=$arr_nationality_s[$an]\">Amend</a>&nbsp;&nbsp;";
echo "<a href=\"delgrperiodvt.php?cin=$arr_from_dates1[$ad]&cout=$arr_to_dates1[$ad]&hot=$s_hotelsb&viewt=$arr_view_type[$av]&nat=$arr_nationality_s[$an]\">Delete</a>";
...
$query_gsno ="select g_rate_sno from seq";
...
?>
                          <form name="gquot" action="<?php echo $_SERVER['PHP_SELF']; ?>"  method="post" onSubmit="return fun2(this)">
                            ...
                            <tr bgcolor="#CCCCCC"> 
                              <td colspan="4"><img src="../images/hotel_icon.gif" width="23" height="14" align="absmiddle">&nbsp;Hotel 
                                Rates Entry  </td>
                              <td><input type="button" id ="hotelreport" name="hotelreport" value="Hotel Rates Report" onClick="OpenWindow()"> </td>
                            </tr>
                            <tr> 
                              <td colspan="5">Hotel: 
