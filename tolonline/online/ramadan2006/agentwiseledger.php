<html>
<head><title>DORS ERP 2.0 - Ramadan Payment Ledger</title>
  ...
  <table border=1 cellpadding="2" cellspacing="0">
    <tr bgcolor="#D4D4D4"> 
      <td colspan="10"><div align="center"> <font size="3" face="Arial, Helvetica, sans-serif">  
          <?
  echo "DORS - Ramadan 2006 Payment Ledger<br>" . $agentname . ", " . $agentcountry . " Email: " . $agentemail?>
          </font></div></td>
    </tr>
    <tr> 
...
?>
	...
	<tr> 
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><? echo date( 'd-M' , strtotime($row["orderdate"])) ;?></font></td>
