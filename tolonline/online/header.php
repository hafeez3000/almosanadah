...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #006600; border-top: 3px solid #006600; border-right: 3px solid #006600">
  <tr> 
    ...
    <td width="56" rowspan="2"><img src="../images/logo.jpg"></td>
  ...
  <tr> 
    <td width="1" bgcolor="#006600" >&nbsp;</td>
    <td  width="350"><strong><font size="2" face="Arial, Helvetica, sans-serif"> 
      <? echo $company_name ; ?>
      </font></strong></td>
    <td width="1" bgcolor="#006600">&nbsp;</td>
    ...
    <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="head" href="logout.php" >Logout</a></font></div></td>
  </tr>
</table>
