...
$query_hotel ="select hotel_id, hotel_name,hotel_type from hotels where account_code!='0' order by hotel_name";
...
$array_hotel_type[] = $rows_hotel["hotel_type"];
...
<table width="100%" cellpadding="1" cellspacing="0"><tr>
  ...
  <table align="left">
   <tr>
    ...
    <tr>
      ...
      <td bgcolor="#DFFFDF" ><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">City&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
  ...
  echo  "<option value=\"$array_city_id[$i]\">$array_city[$i]</option>";
	...
	?>
      ...
      <td bgcolor="#DFFFDF" ><div align="center">&nbsp;</div></td>
    </tr>
    <tr align="left">
      <td valign="top" bgcolor="#EFEFEF"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Hotel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 echo  "<option class=\"$cv\"  value=\"$array_hotel_id[$i]\">$array_hotel[$i] - ($array_hotel_type[$i])</option>";
		}
	?>
        </select>
...
<td bgcolor="#EFEFEF">&nbsp;</td>
    ...
    <tr>
	      <td colspan="3" bgcolor="#EFEFEF"><div align="center"></div></td>
    </tr>
	<tr><td colspan="4"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">OR</font></div></td></tr>
	<tr><td colspan="4" bgcolor="#EFEFEF">   Enter the Hotel Name :<input type="text" id="hotelname" name="hotelname" onFocus="subdis()" onKeyPress="return noenter()" > <input type="button" name="searchhotel" value="Search" onClick="OpenWindow()"></td></tr>
