...
<?
$q_amd_period = "update ind_rates set from_date='$fromd', to_date='$tod' where hotel_id='$g_hot' and from_date= date '$g_cin' and  to_date = date '$g_cout' and nationality='$g_nat'";
