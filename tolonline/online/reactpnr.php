...
$sqlinsacc1 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('CS','$vocno',$vocsno,'now','$agent_acc_code','$ac_nar',$hotel_s_rate,0,'$s_pnr',$main_seq,'f',$s_hotels_sno,'H','$ac_md')"; 
pg_query($sqlinsacc1);
...
$sqlinsacc2 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('CS','$vocno',$vocsno,'now','501001','$ac_nar',0,$hotel_s_rate,'$s_pnr',$main_seq,'f',$s_hotels_sno,'H','$ac_md')"; 
pg_query($sqlinsacc2);
...
$sqlinsacc3 = "insert into vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('PV','$vocno',$vocsno,'now','600002','$ac_nar',$hotel_n_rate,0,'$s_pnr',$main_seq,'f',$s_hotels_sno,'H','$ac_md')"; 
pg_query($sqlinsacc3);
...
$sqlinsacc4 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('PV','$vocno',$vocsno,'now','$supp_account_code','$ac_nar',0,$hotel_n_rate,'$s_pnr',$main_seq,'f',$s_hotels_sno,'H','$ac_md')"; 
pg_query($sqlinsacc4);
...
$sqlinsacc1 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('TS','$vocno',$vocsno,'now','$agent_acc_code','$ac_nar',$s_tot_sell_rate,0,'$s_pnr',$main_seq,'f',$s_sales_trans_sno,'T','$ac_md')"; 
pg_query($sqlinsacc1);
...
$sqlinsacc2 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('TS','$vocno',$vocsno,'now','501004','$ac_nar',0,$s_tot_sell_rate,'$s_pnr',$main_seq,'f',$s_sales_trans_sno,'T','$ac_md')"; 
pg_query($sqlinsacc2);

$vocsno=1;
$ac_nar="";
$ac_nar = "CR Purchases - ". $s_gtitle .". ".$s_gname." - ". $trans_c_name .", ".$city." - ".$s_pnr; 	 	
$ac_nar = substr($ac_nar,0,254);

$sqlinsacc3 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('TP','$vocno',$vocsno,'now','600005','$ac_nar',$s_tot_net_rate,0,'$s_pnr',$main_seq,'f',$s_sales_trans_sno,'T','$ac_md')"; 
pg_query($sqlinsacc3);
...
$sqlinsacc4 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('TP','$vocno',$vocsno,'now','$account_codet','$ac_nar',0,$s_tot_net_rate,'$s_pnr',$main_seq,'f',$s_sales_trans_sno,'T','$ac_md')"; 
pg_query($sqlinsacc4);
...
$q_visa_sel ="select sales_visa_sno,req_date_time,no_adults,no_child,no_infant,sell_adults,tot_sell_adults,tot_sell_child,tot_sell_infant,tot_net_adults,tot_net_child,tot_net_infant,booking_status from sales_visa where ocode='$s_pnr' order by sales_visa_sno";
...
$sqlinsacc1 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('US','$vocno',$vocsno,'now','$agent_acc_code','$ac_nar',$gtotv_sell,0,'$s_pnr',$main_seq,'f',$s_sales_visa_sno,'V','$ac_md')"; 
pg_query($sqlinsacc1);
...
$sqlinsacc2 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('US','$vocno',$vocsno,'now','501003','$ac_nar',0,$gtotv_sell,'$s_pnr',$main_seq,'f',$s_sales_visa_sno,'V','$ac_md')"; 
pg_query($sqlinsacc2);

$vocsno=1;
$ac_nar="";
$ac_nar = "CR Purchase - SABB 021 308 713 001 (Way to Umrah) - ". $s_gtitle .". ".$s_gname." - ".$s_pnr; 	
$ac_nar = substr($ac_nar,0,254);

$sqlinsacc3 = "insert into vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('UP','$vocno',$vocsno,'now','600004','$ac_nar',$gtotv_net,0,'$s_pnr',$main_seq,'f',$s_sales_visa_sno,'V','$ac_md')"; 
pg_query($sqlinsacc3);

$vocsno++;
$ac_nar="";
$ac_nar = "CR Purchase for - ". $s_gtitle .". ".$s_gname." - ".$s_pnr ." - ".$agent_c_name.",". $agent_country;
$ac_nar = substr($ac_nar,0,254);

$sqlinsacc4 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('UP','$vocno',$vocsno,'now','101123','$ac_nar',0,$gtotv_net,'$s_pnr',$main_seq,'f',$s_sales_visa_sno,'V','$ac_md')"; 
pg_query($sqlinsacc4);
...
$sqlinsacc1 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('CS','$vocno',$vocsno,'now','$agent_acc_code','$ac_nar',$sell_rate,0,'$s_pnr',$main_seq,'f',$s_sales_extra_sno,'X','$ac_md')"; 
pg_query($sqlinsacc1);
...
$sqlinsacc2 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('CS','$vocno',$vocsno,'now','501005','$ac_nar',0,$sell_rate,'$s_pnr',$main_seq,'f',$s_sales_extra_sno,'X','$ac_md')"; 
pg_query($sqlinsacc2);

$vocsno=1;
$ac_nar="";
$ac_nar = "CR Purchase - Extra (Others) Suppliers  - ". $s_gtitle .". ".$s_gname." - ".$s_pnr; 	
$ac_nar = substr($ac_nar,0,254);

$sqlinsacc3 = "insert into vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('PV','$vocno',$vocsno,'now','600006','$ac_nar',$net_rate,0,'$s_pnr',$main_seq,'f',$s_sales_extra_sno,'X','$ac_md')"; 
pg_query($sqlinsacc3);
...
$sqlinsacc4 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('PV','$vocno',$vocsno,'now','412000','$ac_nar',0,$net_rate,'$s_pnr',$main_seq,'f',$s_sales_extra_sno,'X','$ac_md')"; 
pg_query($sqlinsacc4);
