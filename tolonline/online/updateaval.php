...
pg_query("create table rates$s_hot_id ( rate_sno int8 NOT NULL, room_id varchar(10),   no_of_paxs int2,   rate_date date, avialibility int2,   avial_bool bool,   allotment int2,  PRIMARY KEY (rate_sno))" );
