...
$query  = "SELECT ocode,cin, cout,hotel_id, room_id,no_rooms,no_nights,cus_paid,booking_status,net_rate,sell_rate,room_inhouseno,hotel_confirmation_no,cus_voucher, guest_occ_status, cus_paid from sales_hotels where order_date between date '$fromd' and date '$tod' + integer '1' $not_arr  $q_hotel order by cin";
...
<tr><td colspan="9" align="center"> Totals </td><td><? echo $tot_net ; ?> </td><td><? echo $tot_sell ; ?></td><td><? echo $tot_sell-$tot_net ; ?></td></tr>
