...
$query  = "SELECT  ocode,f2t,type_of_trans,no_of_units,req_date_time,no_of_paxs,flight_det,net_rate,sell_rate,tot_net_rate,tot_sell_rate,booking_status,occp,order_date,option_date,cus_voucher,cus_account_code,supp_account_code,supp_invoice,cus_paid,amend_bull,trans_id,kind_of_trans,trans_model,supp_rep,trans_id_s from sales_trans where cus_account_code='$q_agentname' and $date_bulls between date '$fromd' and  date '$tod' + integer '$datei'  $not_arr  order by req_date_time";
