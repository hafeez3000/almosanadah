...
<table width="100%" >
  ...
  <tr> 
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"> 
       <strong> <? echo $ar_company_name ; ?></strong>
        </font></div></td>
  </tr>
  <tr> 
    <td><div align="center"><font size="4" face="Arial, Helvetica, sans-serif"> 
...
<table width="100%"><tr><td><center>
	   ...
	   <form name="login" action="logina.php" method="post" onsubmit="return val(this)">
	            <table width="100%" align="center" >
                  <tr> 
                    <td colspan="2"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><font color="#297E7E" size="4" face="Arial, Helvetica, sans-serif">Welcome 
                        to Sales & Reservation</font><strong> </strong></font></div></td>
                  </tr>
                  <tr> 
