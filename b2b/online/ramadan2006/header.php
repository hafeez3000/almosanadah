...
if (!isset($_SESSION['db_is_logged_in_sr']) 
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #006600; border-top: 3px solid #006600; border-right: 3px solid #006600">
  <tr> 
    ...
    <td width="56" rowspan="2"><img src="../../images/logo.gif" width="56" height="56"></td>
    <td width="182" DIR="RTL" align="left"><font size="4" face="Arial, Helvetica, sans-serif"><strong> 
      <? echo $ar_company_name ; ?></strong>
      </font></td>
    <td width="1" bgcolor="#006600">&nbsp;</td>
    <td width="63" rowspan="2" bgcolor="#87D37E" style="border-right: 3px solid #006600"><div align="center"><font size="4" face="Verdana, Arial, Helvetica, sans-serif"><strong><font size="3" face="Arial, Helvetica, sans-serif">ERP 2.0</font></strong></font></div></td>
    <td colspan="2" style="border-bottom: 1px solid #006600"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>&nbsp;Department:</strong> 
      <? echo $dept ?>
      </font></td>
    <td   style="border-bottom: 1px solid #006600"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>User:</strong> 
      <? echo $suserid ?>
      </font></td>
  </tr>
  <tr> 
    <td width="1" bgcolor="#006600" >&nbsp;</td>
    <td  width="182"><font size="4" face="Arial, Helvetica, sans-serif"> 
      <? echo $company_name ; ?>
      </font></td>
    <td width="1" bgcolor="#006600">&nbsp;</td>
    <td width="240"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
    ...
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="head" href="../index.php" >ERP 
        HOME</a> </font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="head" href="logout.php" >Logout</a></font></div></td>
  </tr>
</table>
<?
...
$querycr = "SELECT * from hotels"; 
$resultcr = pg_query($querycr); 
if (!$resultcr) {
	echo "An error occured.\n";
	exit;
	}
$rowcr = pg_fetch_array($resultcr); 
//echo $usern = $rowcr["sno"];
//echo $userc = $rowcr["hotelid"];
pg_free_result($resultcr);
