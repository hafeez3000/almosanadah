...
<html>
<head>
<title>Dheyafa Al Taj - Userid Activation Center</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
</head>
<center>
<body>
...
<tr>
      <td colspan="2" style="border-bottom: 1px solid #FF0000;"><a href="http://www.dheyafataj.com" ><img src="http://agents.dheyafataj.com/images/logo.jpg" border="0"></a></td>
</tr>
<tr>
...
padding:2px;">Admin - Userid Activation Center</td>
          ...
          <tr>
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Salamo
              ...
              Thank you for registering at www.dheyafataj.com<br>
              </font></td>
          </tr>
          <tr>
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">We
              ...
              <a href="http://agents.dheyafataj.com/verify.php?uid=$uid&verify=$verify"> http://agents.dheyafataj.com/verify.php?uid=$uid&verify=$verify</a><br>
              <br>
              </font></td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="border-bottom: 1px solid #FF0000;" align="right"><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Adminstration Dept - WWW.TRIPOFLIFE.NET <br>
                <br></font></div></td>
          </tr>
          <tr>
            <td align="right"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Keep doing online bookings in smart way to save time and money - Dheyafa Al Taj  -  <a href="mailto:info@dheyafataj.com">info@dheyafataj.com</a></font></td>
          </tr>
        </table>
      </td>
  </tr>
...
ENDH;
    ...
    */
    ...
    $subject_s = "Dheyafa Al Taj - New User Registration at : " . date("r")." (GMT)";

    //Create a message


    $message = Swift_Message::newInstance($subject_s)
    ->setFrom(array('info@dheyafataj.com' => 'Dheyafa Al Taj'))
    ->setTo(array($email))
 ...
 Congratulations!!!, <br> Your profile successfully registered. <br> In couple of moments you will receive profile activation email link. <br> For Further queries  <a href="http://www.dheyafataj.com/index.php/contacts">contact us</a>
