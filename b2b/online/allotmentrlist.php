...
$query_sub_room_allot  = "SELECT allotment from rates$hotelid where rate_date between date '$sfdate' and date '$stdate'  and room_id = '$room_id' ";

$result_sub_room_allot = pg_query($query_sub_room_allot);
