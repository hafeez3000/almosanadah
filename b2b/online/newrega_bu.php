...
$mail->setFrom('DORS - Admin <admin@dheyafataj.com>');
...
$mail->setRRT('receipts@dheyafataj.com');
$mail->setNRUDT('receipts@dheyafataj.com');
...
$stext='Salamo alaikum' . $user_first_name .'!Thank you for registering at dheyafataj.com. We have been received your registration with userid ::' . $uid . ', and inorder to activate userid please click on the link  http://www.dheyafataj.com/dorsERP/dors/online/verify.php?uid='.$uid.'&verify='.$verify.' Note: If you have problem in viewing this email,please ENCODE the character set to UNICODE ( UTF-8 ). Keep doing online bookings in smart way to save time and money - Dar Al Manasek - Virtually go anyware in Kindom of Saudi Arabia';
...
<tr>
      <td colspan="2" style="border-bottom: 1px solid #FF0000;"><a href="http://www.dheyafataj.com" ><img src="logo.jpg" border="0"></a></td>
</tr>
<tr>
...
padding:2px;">Admin - Userid Activation Center</td>
          ...
          <tr> 
            <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">We 
              ...
              <a href="http://www.dheyafataj.com/dorsERP/dors/online/verify.php?uid=$uid&verify=$verify"> http://www.dheyafataj.com/dorsERP/dors/online/verify.php?uid=$uid&verify=$verify</a><br>
              <br>
              </font></td>
          </tr>
          <tr>
...
$result2 =  $mail->send(array("admin@dheyafataj.com"), 'smtp');
