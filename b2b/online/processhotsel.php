		...
		document.location.href=hotno ;
								...
								<tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
                                    <input type="text" id="ha_no" name="ha_no" value='<? echo $s_hotel_confirmation_no ; ?>' size="3"><br>
...
'<? echo "&hotid=".$s_hot_id ?>'+"&ag_vno="+document.getElementById ("ag_vno").value;
		document.location.href=ag_vn ;
                                ...
                                <tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
                                    <input type="text" id="ag_vno" name="ag_vno" value='<? echo $s_cus_voucher ; ?>' size="3">
...
'<? echo "&hotid=".$s_hot_id ?>'+"&pd_amt="+document.getElementById ("pd_amt").value;
		document.location.href=pd_amtt ;
                                ...
                                <tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
                                    <input type="text" id="pd_amt" name="pd_amt" value='<? echo $s_cus_paid ; ?>' size="3">
