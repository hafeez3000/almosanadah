                      ...
                      <td> 
                         ...
                         <tr><td>
						  ...
						  <table width="100%" border="0" cellspacing="0">
							 <tr><td>
<?
$q_main_sel ="select main_sno,	ocode,user_sno,user_id,guest_name,order_date,option_date,booking_status,cus_company_name,cus_country,sales_hotels,sales_trans,sales_visa,sales_others from sales_main where  cus_account_code='$q_agentname' and order_date between '$from_date' and date '$to_date' + integer '1' and booking_status like '$s_booking_status' $q_type_booking  order by order_date, guest_name";
