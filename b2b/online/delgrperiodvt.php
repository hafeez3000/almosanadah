...
<?
$q_del_period = "delete from group_rates where hotel_id='$g_hot' and from_date= date '$g_cin' and  to_date = date '$g_cout' and nationality='$g_nat' and view_type='$g_viewt'";
