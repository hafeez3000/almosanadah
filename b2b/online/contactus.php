...
<script type="text/javascript">
  ...
  var html ='<font style="font-family: Verdana,Arial,Helveticaans-serif;font-size:11px;"><div  style=float:left;padding-right:5px></div><div style=float:left ><a href=http://www.dheyafataj.com><b>Dar Al Manasek Tourism & Umrah</b></a><br>201, Gulf Center, Madinah Road,<br /> Jeddah-21418, Saudi Arabia</div></font>' ;
					...
					<div class="left-col">
						...
						<table cellpadding="0" cellspacing="0">		
							<tr id="user-companyName-container">
									...
									<td class="libelle"><a href="mailto:deyafahsales@gmail.com">
              deyafahsales@gmail.com</a>      
									</td>
								</tr>	
									...
									<td class="libelle"><a href="mailto:umrah@dheyafataj.com">
              umrah@dheyafataj.com</a>      
									</td>
								</tr>					
									<tr id="user-companyName-container">
									<td class="libelle"><label for="user-companyName">Admin Department
                  </label></td>
									<td class="libelle"><a href="mailto:admin@dheyafataj.com">
              admin@dheyafataj.com</a>      
									</td>
								</tr>	
                <tr id="user-companyName-container">
									<td class="libelle"><label for="user-companyName">Accounts Department
                  </label></td>
									<td class="libelle"><a href="mailto:accounts@dheyafataj.com">
              accounts@dheyafataj.com</a>      
									</td>
								</tr>	
							</table>
					</div>
 ...
 --> 
					...
					<div class="left-col">
						...
						<table cellpadding="0" cellspacing="0">		
							<tr id="user-companyName-container">
									...
									<td class="libelle">deyafahsales@gmail.com (MSN)      
									</td>
								</tr>	
		<!--					<tr id="user-companyName-container">
									<td class="libelle"><label for="user-companyName">Waheed Anjum (Reservations Department)
                  </label></td>
									<td class="libelle">waheed.anjum@dheyafataj.com(MSN)      
									</td>
								</tr>
                -->		
                        <tr id="user-companyName-container">
                            ...
                            <td class="libelle">accounts@dheyafataj.com(MSN)      
                            </td>
								</tr>
          	...
          	<tr id="user-companyName-container">
									...
									<td class="libelle">mohd.hosny@dheyafataj.com (MSN)      
									</td>
								</tr>	
							<tr id="user-companyName-container">
									<td class="libelle"><label for="user-companyName">Ahmad Al Nashawati (Reservations Department)
                  </label></td>
									<td class="libelle">ahmad.alnashawati@dheyafataj.com (MSN)      
									</td>
								</tr>	
	...
	<h1><span class="titleNumberOn">5</span>. We're Hiring</h1>
          	...
          	<tr id="user-companyName-container">
									...
									<td class="libelle"><a href="mailto:ceo@dheyafataj.com">ceo@dheyafataj.com </a>
									</td>
								</tr>	
				...
				<fieldset class="fieldset-container" id="fieldset2">
                  ...
                  <td class="libelle"><a href="http://www.facebook.com/profile.php?id=113050495417547" target="_blank"><img src="images/facebook.jpg" border="0" ></a>
          				  	...
          				  	<tr id="user-companyName-container">
									...
									<td class="libelle"><a href="http://www.twitter.com/dheyafataj" target="_blank"><img src="images/twitter.jpg" border="0" ></a>
