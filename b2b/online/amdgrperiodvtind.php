...
<form name="gquot" action="amdgrperiodvtinda.php"  method="post" onsubmit="return fun2(this)">
                            <tr> 
                              <td colspan="5">&nbsp;</td>
                            </tr>
                            <tr bgcolor="#CCCCCC"> 
