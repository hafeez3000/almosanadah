...
$sqlinsvisa = "insert into sales_visa(sales_visa_sno,main_sno,ocode,cus_account_code,	user_sno,	user_id, req_date_time,	no_adults, no_child,no_infant,net_adults,sell_adults,net_child,sell_child,net_infant,	 sell_infant,tot_net_adults,	tot_sell_adults,tot_net_child,	tot_sell_child,tot_net_infant,	tot_sell_infant,order_date,booking_status,is_online )  values($visa_seq,$smain_sno,'$s_pnr','$scus_account_code',$suser_sno,'$suserid','$reqdate', $n_adult, $n_child, $n_infant, $s_adult_net_rate, $s_adult_sell_rate, $s_child_net_rate, $s_child_sell_rate, $s_infant_net_rate, $s_infant_sell_rate, $tot_adult_net_rate, $tot_adult_sell_rate, $tot_child_net_rate, $tot_child_sell_rate, $tot_infant_net_rate, $tot_infant_sell_rate, 'now','On Request',1 )"; 
pg_query($sqlinsvisa);
...
$vocsno=1;
$ac_nar="";
$ac_nar = "CR Purchase - SABB 021 308 713 001 (Way to Umrah) - ". $sguest_title .". ".$sguest_name." - ".$s_pnr;	
$ac_nar = substr($ac_nar,0,254);
...
$sqlinsacc4 = "insert into 	vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,dbamt,cramt,pnr,invno,recon,sinvno,sinvtype,moredet) values('UP','$vocno',$vocsno,'$reqdate','101123','$ac_nar',0,$gtotv_net,'$s_pnr',$smain_sno,'f',$visa_seq,'V','$ac_md')"; 
pg_query($sqlinsacc4);
