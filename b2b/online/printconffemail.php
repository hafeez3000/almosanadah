...
$q_main_sel ="select main_sno,ocode,is_online,user_sno,user_id,guest_title,guest_name,guest_notes,order_date,option_date,cus_account_code,cus_title,cus_name,cus_company_name,cus_country,cus_contact,cus_email,agent_notes,sales_hotels,sales_trans,sales_visa,sales_others from sales_main where ocode='$s_pnr'";
...
$ac_det = "A/C: Mr. JAMAL ABDULLAH MUKHTAR, 12022016000102, National Commercial Bank, Manara Branch, Jeddah, K.S.A";
...
<tr>
      <td  align="center" ><font face="Arial, Helvetica, sans-serif"><strong><?php echo $s_online ?> BOOKING CONFIRMATION </strong></font></td>
    </tr></table>
...
echo "<tr><td colspan=\"2\" style=\"border-bottom: 1px dotted #999999;\"><div align=\"left\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Invoice No:$s_main_sno-H-$s_hotels_sno</font></td><td colspan=\"2\" style=\"border-bottom: 1px dotted #999999;\"><div align=\"right\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\">Price: ". $tot_hot ."</font></div></td>";
echo "</tr>";
...
if($print_con_zam_zam){
	$ac_det = "A/C: Dar Al Manasek Tourism & Umrah Service Co.LTD , 13668353000109, National Commercial Bank ( Swift Code :NCBKSAJE or IBAN : SA24 1000 0013 6683 5300 0109 ) , Hail Street Branch, Jeddah, K.S.A";}
else {
	$ac_det = "A/C: Dar Al Manasek Tourism & Umrah Service Co.LTD , 13668353000109, National Commercial Bank ( Swift Code :NCBKSAJE or IBAN : SA24 1000 0013 6683 5300 0109 ) , Hail Street Branch, Jeddah, K.S.A";
}
...
if($s_cus_country=="Kuwait"){
$ac_det = "A/C: Mr. ABDULLAH JAMAL ABDULLAH MOKHTAR, 2002218018
, National Bank of Kuwait (NBK), South Surra Branch, Kuwait. Swift Code:NBOKKWKW
  ";

}

if($s_cus_country=="Qatar"){
$ac_det = "A/C: Mr. ABDULLAH JAMAL ABDULLAH MOKHTAR, 0060-704759-043
, QNB (QATAR NATIONAL BANK), CITY CENTER BRANCH,Qatar. SWIFT CODE : QNBAQAQA";
...
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 1px solid #999999;">
<tr><td align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> Grand Total Price:  </font></td><td width="17%" style="border-bottom:  double #999999;"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b><?echo $currency_s ;?>#<? echo number_format($g_tot, 2, "." , ",")?>/-</b></font></td></tr>
...
<br>
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr><td align="justify"><font size="4" face="Verdana, Arial, Helvetica, sans-serif"> <b> <? echo date('D, jS M, Y H:i ', strtotime($s_option_date)); ?> </b> </font><font size="2" face="Verdana, Arial, Helvetica, sans-serif">is option date for payment, Kindly Transfer above Amount to <? echo $ac_det; ?> </font></td></tr>



<tr><td align="justify"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br> *This booking will be confirmed upon receipt of the request deposit. Please send us a copy of Bank transfer. In Case of Non-Payment of Above Amount before option date, Your Booking Request will be automatically cancelled. Thereafter Dheyafa Al Taj is not responsible in any circumstances. **This Booking will be confirmed on NON-Cancelable, NON-Amendable and NON-Refundable constraint. ***Bank Transfer Charges will be extra as per your Money Exchange Agent</font>
</td></tr> 
<?
