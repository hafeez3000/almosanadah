...
<table width="100%" height="6%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CAFFCA">
  <tr>
            <td><font size="2" face="Arial, Helvetica, sans-serif"><strong>&nbsp;Deleting Period from Reservation Transportation Rates ...</strong></font></td>
...
<?
$q_del_period = "delete from res_trans_rates where trans_id like'$g_hot%' and from_date= date '$g_cin' and  to_date = date '$g_cout' and nationality='$g_nat'";
pg_query($q_del_period);
