...
session_start();
$q_agentname=$s_agentname = $_SESSION['user_a_code'];
...
$q_hotel_sel ="select ocode from sales_hotels where cin between '$from_date' and  '$to_date'  and booking_status like '$s_booking_status'   and cus_account_code=$q_agentname  order by cin";
...
$q_trans_sel ="select ocode from sales_trans where req_date_time between '$from_date' and '$to_date' and booking_status like '$s_booking_status' and cus_account_code=$q_agentname order by req_date_time";
...
$q_visa_sel ="select ocode from sales_visa where req_date_time between '$from_date' and date '$to_date' + integer '1' and booking_status like '$s_booking_status' and cus_account_code=$q_agentname order by req_date_time";
...
$q_extra_sel ="select ocode from sales_extra where req_date_time between '$from_date' and '$to_date' and booking_status like '$s_booking_status' and cus_account_code=$q_agentname order by req_date_time";
...
$q_visa_sel ="select ocode from sales_extra where req_date_time between '$from_date' and '$to_date' and booking_status like '$s_booking_status' and cus_account_code=$q_agentname order by req_date_time";
