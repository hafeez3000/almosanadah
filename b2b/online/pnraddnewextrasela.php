...
$sqlinsextra = "insert into sales_extra( sales_extra_sno,main_sno,ocode,cus_account_code,user_sno,user_id,req_date_time,paticulars,net_rate,sell_rate,order_date,booking_status,is_online)  values($extra_seq,$smain_sno,'$s_pnr','$scus_account_code',$suser_sno,'$suserid','$others2rd','$other2noofa',$other2nrate,$other2srate,'now','On Request',1)"; 
...
$vocsno=1;
$ac_nar="";
$ac_nar = "CR Purchase - Extra (Others) Suppliers  - ". $sguest_title .". ".$sguest_name." - ".$s_pnr; 		
$ac_nar = substr($ac_nar,0,254);
