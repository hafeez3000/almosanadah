...
$sqlinshot = "insert into 	sales_hotels(sales_hotels_sno,main_sno,ocode,cus_account_code,supp_account_code,user_sno,user_id,hotel_id,room_id,cin,cout,no_rooms,no_nights, no_paxs,net_rate,sell_rate,booking_status,order_date,supp_id,is_online) values($hotel_seq,$smain_sno,'$s_pnr','$scus_account_code','$supp_account_code',$suser_sno ,'$suserid','$s_hotelsmad','$mad_s_rid','$madcin','$madcout',$mad_s_selr,$madnights,$mad_s_selp,$mad_s_hotnt,$mad_s_hott,'On Request','now','$supp_empty',1)"; 
pg_query($sqlinshot);
...
$sqlmainopu = "update sales_main set sales_hotels='t',order_date='now',option_date='$optiondate',booking_status='On Request' where  ocode='$s_pnr'"; 
pg_query($sqlmainopu);
