...
<script>
document.title= '<? echo $company_name . " ERP - New Extra Bookings"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      are here: <a href="uhome.php">Home</a> &raquo; <a href="bookings.php">Bookings</a>  &raquo; <a href="newbookings.php">New Bookings</a> &raquo; New Extra Booking</a></font></td>
  </tr></table>
 ...
 <tr bgcolor="#E8D2D2">
  ...
  <tr><td colspan="4">
					        ...
					        <table align="center" width="100%">
                              ...
                              <tr> 
                                <td>&nbsp;                                 </td>
                                <td><input type="hidden" id="other2nrate" name="other2nrate" size="2" value="<? echo $s_net_rate; ?>">                                  <input type="hidden" id="other2srate" name="other2srate" size="2" value="<? echo $s_sell_rate; ?>"></td>
