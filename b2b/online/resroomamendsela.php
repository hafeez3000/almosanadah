...
$sqlinshot = "update sales_hotels set hotel_id='$s_hotelsmad',room_id='$mad_s_rid',cin='$madcin',cout='$madcout',no_rooms=$mad_s_selr,no_nights=$madnights,no_paxs=$mad_s_selp,net_rate=$mad_s_hotnt,sell_rate=$mad_s_hott,booking_status='On Request',order_date='now',supp_account_code='$hotel_account_code',supp_id='$supp_empty' where sales_hotels_sno=$hotel_seq and ocode='$s_pnr'"; 
pg_query($sqlinshot);
