...
<table  cellpadding="3" cellspacing="3" border="1" align="center">
									...
									<tr >
                            <td colspan="2" align="center"><img src="http://www.dheyafataj.com/tol/images/logo.jpg"></td>
                          </tr>
...
$subject_s = "Dheyafa Al Taj - New Email Request : " . date("r")." (GMT)";
//Create a message


$message = Swift_Message::newInstance($subject_s)
  ->setFrom(array('info@dheyafataj.com' => 'Dheyafa Al Taj - Reservation'))
