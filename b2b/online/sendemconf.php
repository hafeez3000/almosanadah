...
$mail->setFrom('DORS - Reservation <deyafahsales@gmail.com>');
...
curl_setopt($ch,CURLOPT_URL,"http://localhost/dorsERP/umrah/printconffemail.php");
...
$mail->addEmbeddedImage(new fileEmbeddedImage('logo.gif'));
...
//echo $agent_email;
//$agent_email="admin@dheyafataj.com";
