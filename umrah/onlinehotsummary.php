...
<script>
document.title= '<? echo $company_name . " ERP - Online Hotel Summary"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
      are here: <a href="uhome.php">Home</a> &raquo; Reports &raquo; Online Hotel Summary</a></font></td>
  </tr></table>
...
pg_free_result($result_hotel);
	...
	?>
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Online Hotel Summary </strong>- Select Hotel </td>
                    </tr></table>
...
var rr = "onlinehsmain.php?hot_id="+document.selhotel.hotelv.value+"&f_d="+from_d+"&t_d="+to_d;
...
window.open(rr, hid ,'width='+screen.width+',height='+screen.height+', directories=no,menubar=yes,scrollbars=yes,toolbar=no,resizable=yes,fullscreen=no,titlebar=no,directories=no, top=0,left=0  ').focus();
    ...
    <tr>
         ...
         <input type="hidden" name="hotelv">
		   <input type="button" name="mainsub" value="Get Online Hotel Summary" onclick="g_hs();">
        </div></td>
    </tr>
