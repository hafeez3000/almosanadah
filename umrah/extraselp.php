...
grand_sell(grand_gt);
  ...
  <td colspan="1" align="center" bgcolor="#EFEFEF" style="border-right: 1px solid #999999; border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="other2net" name="other2net" value='<? echo $other2nrate ?>' size="2" onKeyUp="other2nt()"  onFocus="other2nt()" onBlur="other2nt()"></font></td>
