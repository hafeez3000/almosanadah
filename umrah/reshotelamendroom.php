...
checked = theForm.querySelectorAll("input[type=checkbox]:checked").length;
  if (!checked) {
    ...
    return false;
                    ...
                    <form name="gquot" action="resroomamendsel.php" method="post" onSubmit="return validateForm(this)">
                        ...
                        <tr bgcolor="#EFEFEF">
                          <td colspan="4">
                            ...
                            for ($roid = 0; $roid < count($array_room_id); $roid++) {
                              ...
                              for ($bc = 0; $bc < (isset($madnights1) ? $madnights1 : 0); $bc++) {
                              ...
                              if ($status == 1 && $avail_bullt == "t" && min((array) $avail_rooms) > 0) {
                                ...
                                for ($rm = 1; $rm <= min((array) $avail_rooms); $rm++) {
