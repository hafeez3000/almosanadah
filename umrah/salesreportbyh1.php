        ...
        <tr>
          <td valign="top">
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><tt> Hotel Sales Report</tt></td>
                    </tr></table>
                          ...
                          <form name="bbyod" method="post" action="#">
                            ...
                            <tr>
                              ...
                              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                ...
                                </font></td> <td align="left"> <input type="checkbox" name="cbc" id="cbc">
	...
	?>
                            ...
                            <tr>
                              <td colspan="2"><div align="left">
                                  <input type="button" name="get_rl" id="get_rl" value="   Get Report   " onClick="s_h();">
                                </div></td>
