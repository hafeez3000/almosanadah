...
$result_visa = pg_query($conn, $query_visa);
...
<table width="100%" cellpadding="1" cellspacing="0"><tr>
                      <td  style="border-bottom: 1px solid #999999"><div align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
					   <form name="gquot" method="post" action="visasel.php" onSubmit="return fun2(this)">
...
grand_sell(grand_gt);
                              ...
                              <tr>
                                ...
                                <td colspan="2"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    ...
                                    Price</font><br>
                                    <input id="anetprice" name="anetprice" type="text" size="2" value='0' onKeyUp="other2nt()"  onFocus="other2nt()" onBlur="other2nt()">
                                    </font></div></td>
                                <td colspan="1"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    ...
                                    <input id="asellprice" name="asellprice" type="text" size="2" value='0' onKeyUp="other2t()"  onFocus="other2t()" onBlur="other2t()">
                                    </font></div></td>
                              </tr>
                              <tr>
                                <td><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Enter
                                ...
                                <td colspan="2"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    <font size="2" face="Arial, Helvetica, sans-serif">Net
                                    Price</font><br>
                                    <input id="cnetprice" name="cnetprice" type="text" size="2" value='0' onKeyUp="other2nt()"  onFocus="other2nt()" onBlur="other2nt()">
                                    </font></div></td>
                                <td colspan="1"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    <font size="2" face="Arial, Helvetica, sans-serif">Sell
                                    Price<br>
                                    </font>
                                    <input id="csellprice" name="csellprice" type="text" size="2" value='0' onKeyUp="other2t()"  onFocus="other2t()" onBlur="other2t()">
                                    </font></div></td>
                              </tr>
                              <tr>
                                <td><div align="right"><font size="2" face="Arial, Helvetica, sans-serif">Enter
                                ...
                                <td colspan="2"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    <font size="2" face="Arial, Helvetica, sans-serif">Net
                                    Price</font><br>
                                    <input id="inetprice" name="inetprice" type="text" size="2" value='0' onKeyUp="other2nt()"  onFocus="other2nt()" onBlur="other2nt()">
                                    </font></div></td>
                                <td colspan="1"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">
                                    <font size="2" face="Arial, Helvetica, sans-serif">Sell
                                    Price<br>
                                    </font>
                                    <input id="isellprice" name="isellprice" type="text" size="2" value='0' onKeyUp="other2t()"  onFocus="other2t()" onBlur="other2t()">
                                    </font></div></td>
                              </tr>
...
document.getElementById("ttotnet").value= g_net;
}
...
document.getElementById("ttotsell").value= g_sell;
}

</script>


<input id="ttotnet" name="ttotnet" type="hidden" >
<input id="ttotsell" name="ttotsell" type="hidden" >
...
if(document.gquot.ttotnet.value=="0"){
	alert("Sorry, Atlest One pax should be entered.");
		document.gquot.noofa.focus();
		return false;
	}


if(document.gquot.ttotsell.value=="0"){
	alert("Sorry, Atlest One pax should be entered.");
		document.gquot.noofa.focus();
		return false;
	}
