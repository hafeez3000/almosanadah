...
$tot_b=0;
 ...
 $query  = "SELECT cus_account_code from sales_hotels where cout between  date '$tod' - integer '30'  and '$tod' and cout > '$fromd' and ocode!='NC' and booking_status!='Cancelled' and cus_account_code not between 150900 and 159999 or  cin  between '$fromd' and '$tod' and ocode!='NC'  and booking_status!='Cancelled' and cus_account_code not between 150900 and 159999 or   cin between date '$tod' - integer '30' and '$tod' and  cout > '$tod' and ocode!='NC' and booking_status!='Cancelled' and cus_account_code not between 150900 and 159999 group by cus_account_code order by cus_account_code";
...
?>
  <table border=1 cellpadding="2" cellspacing="0" align="center">
    <tr> 
      <td colspan="6"> <div align="center"> <font size="3" face="Arial, Helvetica, sans-serif"> 
          <?
  echo "DORS ERP 2.0 - Ramadan 2007 Balance Payment - Non-Umrah Agents" ?>
          </font></div></td>
    </tr>
    <tr> 
...
?>
    <tr> 
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><a href="agentwiseledger.php?agentacc=<? echo $s_cus_ac; ?>" target="popa" onClick="window.open('','popa', 'width=750,height=500,menubar=yes,scrollbars=yes,status=no top='+wint+',left='+winl+' ')" ><? echo strtoupper($c_name); ?></a></font></td>
...
<td align="right" ><font size="2" face="Arial, Helvetica, sans-serif"><? echo number_format(round((($s_r-$p_a)*100/100),2), 2, "." , ","); ?></font></td></tr>
...
?>
<tr><td colspan="3" align="center"><font size="2" face="Arial, Helvetica, sans-serif">Total</font></td>
...
<td align="right" ><font size="2" face="Arial, Helvetica, sans-serif"><? echo number_format(round((($tot_b)*100/100),2), 2, "." , ","); ?></font></td></tr>
