...
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 1px solid #999999;">
<tr><td align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> Grand Total Price:  </font></td><td width="17%" style="border-bottom:  double #999999;"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b>SAR#<? echo number_format(ceil($g_tot), 2, "." , ",")?>/-</b></font></td></tr></table>

<br>
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr><td align="justify"><font size="4" face="Verdana, Arial, Helvetica, sans-serif"> <b> <? echo date('D, jS M, Y H:i ', strtotime($s_option_date)); ?> </b> </font><font size="2" face="Verdana, Arial, Helvetica, sans-serif">is option date for payment, Kindly Transfer above Amount to A/C: Sohulat Al Safar Umrah Services, SASABB221547706001, SAB (Saudi Awwal Bank), Riyadh, Saudi Arabia, K.S.A </font></td></tr>



<tr><td align="justify"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br> 
*In Case of Non-Payment of Above Amount before option date, Your Booking will be automatically cancelled. Thereafter Sohulat Al Safar Umrah Services is not responsible in any circumstances. **This Booking is confirmed on NON-Cancelable,NON-Amendable and NON-Rrefundable constraint.</font>
</td></tr> 
<?
