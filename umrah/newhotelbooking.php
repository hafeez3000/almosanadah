...
<script type="text/javascript">
   ...
   if ((document.selhotel.hotelname.value== null) || ((document.selhotel.hotelname.value).length==0))
   {
	  ...
	  document.selhotel.hotelname.focus();
        ...
        var winPop = window.open(rr,"winPop",'scrollbars=yes,toolbar=no,resizable=yes,width=550,height=300, top='+10+',left='+300+' ' ).focus();
      }
...
pg_free_result($result_hotel);
	...
	?>
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>New Hotel Booking </strong>- Select Cin/Cout Dates and Hotel </td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0"><tr>
  ...
  <tr> <td colspan="3" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Do you want system to auto-select WeekEnd Package ? </font> <input type="checkbox" id="ch_wep" name="ch_wep" checked ></td></tr>
...
<td bgcolor="#DFDFFF" ><div align="center"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Submit details to</font></strong></div></td>
    </tr>
    <tr align="center">
...
<td bgcolor="#EFEFEF">
 ...
 echo  "<option class=\"$cv\"  value=\"$array_hotel_id[$i]\">$array_hotel[$i]</option>";
	...
	<tr><td colspan="4"><div align="center"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">OR</font></div></td></tr>
	<tr><td colspan="4" bgcolor="#EFEFEF" align="center">Still unable to find Hotel?  Try by Hotel Name:<input type="text" id="hotelname" name="hotelname" onFocus="subdis()" onKeyPress="return noenter()" > <input type="button" name="searchhotel" value="Search" onClick="OpenWindow()"></td></tr>
