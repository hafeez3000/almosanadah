...
<form name="roomselput" action="pnraddnewextrasela.php"  method="post">
...
grand_sell(grand_gt);
  ...
  <td colspan="1" align="center" bgcolor="#EFEFEF" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="other2sell" name="other2sell" value='<? echo $other2srate ?>' size="2" onKeyUp="other2t()"  onFocus="other2t()" onBlur="other2t()"></font></td>
</tr>
</table>
