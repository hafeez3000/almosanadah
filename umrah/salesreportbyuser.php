...
<script src="salesreportbyuserjs.js"></script> 
<? $vy=$vm=$vd=0; 
$vy1=$vm1=$vd1=0;
?>

<script>
document.title= '<? echo $company_name . " ERP - Sales Report by User"; ?>';
</script>

<?
$array_user_id = array();
$array_user_first_name = array();
$array_user_last_name = array();


$query_trans ="select user_id, user_first_name, user_last_name from users where umrah_status=true order by user_first_name";
...
$array_user_id[] = $rows_trans["user_id"];
$array_user_first_name[] = $rows_trans["user_first_name"];
$array_user_last_name[] = $rows_trans["user_last_name"];
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      are here: <a href="uhome.php">Home</a> &raquo;  Reports &raquo; Sales Reports by User</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><strong>Sales Reports by Users</strong></td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0" ><tr>
                      <td> 
                          <table width="100%" border="1" cellspacing="0" style=" border-bottom: 1px solid #999999">
  ...
  echo  "<option value=\"$array_user_id[$i]\">$array_user_first_name[$i]  $array_user_last_name[$i]</option>";
}
	?>
                            ...
                            <tr> 
                              <td colspan="2"><div align="right"> 
                                  <input type="button" name="get_rl" id="get_rl" value="Get Sales Report by user >>>"  onClick="s_h();" >
                                </div></td>
