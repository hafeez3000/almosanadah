...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #006600; border-top: 3px solid #006600; border-right: 3px solid #006600">
  <tr> 
  <td width="100"  rowspan="2" style="border-left: 3px solid #006600;" ><a href="uhome.php"><img class="max-w-sm" src="../images/logo.jpg"></a></td>
  ...
  <tr> 
    <td  width="200"><font  face="Arial, Helvetica, sans-serif" style="font-size: 15px;" > 
    ...
    <td></td>
    <td><div align="left" style="padding-left:5px"; ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><a class="head" href="../index.php" >ERP 
        HOME</a>  </font></div></td>
  </tr>
</table>
...
<?php include ("umrah_functions.php"); ?>
