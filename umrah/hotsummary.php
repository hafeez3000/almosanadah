...
<script>
  document.title = '<? echo $company_name . " ERP - Hotel Summary"; ?>';
</script>
...
<body leftmargin="0" topmargin="0" rightmargin="0">
    ...
    <tr>
      <td bgcolor="#CCCCCC">
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
          are here: <a href="uhome.php">Home</a> &raquo; Reports &raquo; Hotel Summary</a></font>
      </td>
    </tr>
  </table>
                                ...
                                <tr bgcolor="#EFEFEF">
                                  <td colspan="3">
                                    <table align="center">
                                      <tr>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">From:</font>
                                        </td>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                      ...
                                      <tr>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">To:</font>
                                        </td>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                ...
                                <script>
                                  function g_hs() {
                                    ...
                                    if (document.selhotel.hotel.value == "select") {
                                      ...
                                      var f_year = document.selhotel.dYear.value;
                                      var f_month = document.selhotel.dMonth.value;
                                      var f_day = document.selhotel.dDay.value;

                                      var t_year = document.selhotel.d1Year.value;
                                      var t_month = document.selhotel.d1Month.value;
                                      var t_day = document.selhotel.d1Day.value;
                                      ...
                                      var rr = "hsmain.php?hot_id=" + document.selhotel.hotelv.value + "&f_d=" + from_d + "&t_d=" + to_d;
  ...
  <script>
    ...
    now_date1.setDate(now_date1.getDate() + 25)
