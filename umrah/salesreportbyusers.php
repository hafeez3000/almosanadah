...
$query  = "SELECT user_id,ocode,cin, cout,hotel_id, room_id,no_rooms,no_nights,cus_paid,booking_status,net_rate,sell_rate,room_inhouseno,hotel_confirmation_no,cus_voucher, guest_occ_status, cus_paid from sales_hotels where order_date between date '$fromd' and date '$tod' + integer '1'   and user_id='$hotelid' $not_arr  order by cin";
...
<tr><td colspan="6" align="center"> Totals </td><td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $tot_number_nights ; ?></font> </td><td colspan="2" align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $tot_number_nights ; ?></font> </td><td><? echo $tot_net ; ?> </td><td><? echo $tot_sell ; ?></td><td><? echo $tot_sell-$tot_net ; ?></td></tr>
