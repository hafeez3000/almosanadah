...
pg_query($conn, $sequpdat_quot_meals);
...
$result_hotel_acc = pg_query($conn, $query_hotel_acc);
...
pg_query($conn, $sequpdat_quot_hotel);
...
pg_query($conn, $sequpdat_quot_trans);
...
pg_query($conn, $sequpdat_quot_visa);
...
pg_query($conn, $sequpdat_quot_extra);
...
pg_query($conn, $sqlinsextra1);

$sequpdat_quot_extra1 = "update seq set quot_extra=quot_extra+1";
pg_query($conn, $sequpdat_quot_extra1);
...
pg_query($conn, $sqlinsextra2);

$sequpdat_quot_extra2 = "update seq set quot_extra=quot_extra+1";
pg_query($conn, $sequpdat_quot_extra2);
...
pg_query($conn, $sqlinsextra3);

$sequpdat_quot_extra3 = "update seq set quot_extra=quot_extra+1";
pg_query($conn, $sequpdat_quot_extra3);
...
pg_query($conn, $sequpdat_quot_main);
