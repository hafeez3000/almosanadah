...
<script src="totalsalesreportbycjs.js"></script>
<? $vy=$vm=$vd=0;
$vy1=$vm1=$vd1=0;
?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
      are here: <a href="uhome.php">Home</a> &raquo;  Reports &raquo; Total Sales Reports by Country</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top">
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><strong>Total Sales Reports by Country</strong></td>
                    </tr></table>
                          ...
                          <form name="bbyod" method="post" action="#">
                            ...
                            <tr>
                              ...
                              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                ...
                                </font></td> <td align="left"> <img src="../images/print_icon.gif""> <a href="printtotalsalesreportbycountry.php" target="totalsbycreportpop" onclick="window.open('', 'totalsbycreportpop','width=775,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()">Print</a>
			  ...
			  <option value="Libya">Libya</option>
                            ...
                            <tr>
                              <td colspan="2"><div align="center">
                                  <input type="button" name="get_rl" id="get_rl" value="Get Total Sales by Country Report >>>" onClick="s_h();">
                                </div>
...
<script>
   ...
   if (dvy < 2000) dvy += 1900;
	...
	initDates(dvy-1, dvy+1, now_year, now_month , now_day, d1);
