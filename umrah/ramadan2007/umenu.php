...
$ramadan06   = new HTML_TreeNode(array('text' => "Ramadan 2007", 'link' => "#", 'icon' => $icon, 'expandedIcon' => $expandedIcon, 'expanded' => false));
	$ramadan061_1 = &$ramadan06->addItem(new HTML_TreeNode(array('text' => "Hotel Summary", 'link' => "ra07summary.php")));

$ramadan06->addItem(new HTML_TreeNode(array('text' => "All Agents C&C", 'link' => "ramadan2007/agnetswithcc.php")));
$ramadan06->addItem(new HTML_TreeNode(array('text' => "Non-Umrah Agents C&C ", 'link' => "ramadan2007/agnetswithccnu.php")));  
$ramadan06->addItem(new HTML_TreeNode(array('text' => "Umrah Agents C&C ", 'link' => "ramadan2007/agnetswithccu.php")));  
