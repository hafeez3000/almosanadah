...
$query  = "SELECT ocode,cin, cout, no_rooms, guest_occ_status, cus_paid from sales_hotels where cout between  date '$tod' - integer '30'  and '$tod' and cout > '$fromd' and ocode!='NA' and room_id='$roomid' and booking_status!='Cancelled' or  cin  between '$fromd' and '$tod' and ocode!='NA' and room_id='$roomid' and booking_status!='Cancelled' or   cin between date '$tod' - integer '30' and '$tod' and  cout > '$tod' and ocode!='NA' and room_id='$roomid' and booking_status!='Cancelled' order by cin";
...
$p=0;
for ($ja=0; $ja < $df ; $ja++) {
$querya = "select sum(allotment) as allotments from rates$hotelid where rate_date between date '$fromd' + integer '$ja'  and date '$fromd' + integer '$ja'  and room_id='$roomid' ";
