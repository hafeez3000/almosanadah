...
$q_main_sel ="select main_sno,ocode,is_online,user_sno,user_id,guest_title,guest_name,guest_telno,guest_notes,order_date,option_date,cus_account_code,cus_title,cus_name,cus_company_name,cus_country,cus_contact,cus_email,agent_notes,sales_hotels,sales_trans,sales_visa,sales_others from sales_main where ocode='$s_pnr'";
