            ...
            <tr>
              <td>
                <font size="2" face="Arial, Helvetica, sans-serif"><strong>&nbsp;
                    Booking Details </strong></font>
              </td>
              <td valign="top">
                <div align="right"><img src="../images/tr.jpg" width="9" height="10"></div>
              </td>
            </tr>
          </table>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>
                      ...
                      $q_hotel_sel = "select sales_hotels_sno,user_sno,hotel_id,room_id,cin,cout,no_rooms,no_nights,no_paxs,sell_rate,sell_rate_tax  from sales_hotels where sales_hotels_sno=$hotel_sel_sno";
                      ...
                      while ($rows_hotel_sel = pg_fetch_array($res_hotel_sel)) {
                        ...
                        $s_sell_rate_tax = $rows_hotel_sel["sell_rate_tax"];
...
//echo $s_room_id;
                      ...
                      echo "<table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspacing=\"0\"><tr><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Rate Date</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Net Rate</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Selling Rate</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>No of Rooms</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>No of Paxs</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Meals</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>N.VAT</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>S.VAT</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Day Net Total</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Day Total</b></font></div></td></tr>";
                      ...
                      while ($rows_meals_sel = pg_fetch_array($res_meals_sel)) {
                        ...
                        echo "</font></div></td>";
                        echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                        echo $s_room_net_rate = $rows_meals_sel["room_net_rate"];
                        echo "</font></div></td>";
                        echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                        ...
                        $tot_net = $tot_net + $s_room_net_rate;
                        $tot_sell = $tot_sell + $s_room_sell_rate;
                        ...
                        if ($s_breakfast != "N/A") {
                          echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">B/F:" . $s_breakfast . "</font></div></td>";
                        }

                        if ($s_halfboard != "N/A") {
                          echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">H/B:" . $s_halfboard . "</font></div></td>";
                        }
                        if ($s_fullboard != "N/A") {
                          echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">F/B:" . $s_fullboard . "</font></div></td>";
                        }
                        if ($s_sahoor != "N/A") {
                          echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">SAH:" . $s_sahoor . "</font></div></td>";
                        }
                        if ($s_iftar != "N/A") {
                          echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">IFT:" . $s_iftar . "</font></div></td>";
                        }
                        ...
                        echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                        echo $s_day_net_rate_tax = $rows_meals_sel["day_net_rate_tax"];
                        echo "</font></div></td>";

                        echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                        echo $s_day_sell_rate_tax = $rows_meals_sel["day_sell_rate_tax"];
                        echo "</font></div></td>";

                        echo "<td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                        echo $s_day_net_rate = $rows_meals_sel["day_net_rate"];
                        echo "</font></div></td>";
                        ...
                        $tot_net_tax = $tot_net_tax + $s_day_net_rate_tax;
                        $tot_sell_tax = $tot_sell_tax + $s_day_sell_rate_tax;

                        $g_net_hot_tot = $g_net_hot_tot + $s_day_net_rate;
                        ...
                        $g_tot_meals_day = $g_tot_meals * (int) $s_no_of_paxs;
                        $g_tot_meals_day_f = $g_tot_meals_day_f + $g_tot_meals_day;

                        echo "</tr>";
                      }
                      echo "<tr><td colspan=\"1\" align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>Total </strong></font></td><td colspan=\"1\" align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>$tot_net</strong></font></td><td colspan=\"1\" align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>$tot_sell </strong></font></td><td colspan=\"2\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong> </strong></font></td><td colspan=\"1\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>$g_tot_meals_day_f </strong></font></td><td colspan=\"1\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>$tot_net_tax </strong></font></td><td colspan=\"1\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>$tot_sell_tax </strong></font></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">" ?>
                      <? echo ceil((int) $g_net_hot_tot);
                      echo "</font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">";
                      echo ceil((int) $g_hot_tot);
                      echo "</font></div></td></tr>";
                      echo "</table>";
                      ?>
