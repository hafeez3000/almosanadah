        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Bookings by Amendment</strong></td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0"><tr>
                      <td> 
                          <table width="100%" border="0" cellspacing="0" style=" border-bottom: 1px solid #999999">
                          <form name="bbyod" method="post" action="bbyamendmentaction.php">
                            <tr> 
                              <td colspan="2">Find Amendment orders by date</td>
                            </tr>
                            <tr> 
                              <td colspan="2">&nbsp;</td>
                            </tr>
                            ...
                            <tr> 
                              ...
                              <td colspan="2"><div align="right"> 
                                  <input type="submit" name="Submit" value="Find Amended Bookings >>>">
                                </div></td>
                            </tr>
                          </form>
                        </table>
