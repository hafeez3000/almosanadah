...
$query  = "SELECT ocode,cin, cout, room_id,no_rooms,no_nights,cus_paid,booking_status,room_inhouseno,hotel_confirmation_no,cus_voucher, guest_occ_status, cus_paid from sales_hotels where cout between  date '$tod' - integer '30'  and '$tod' and cout > '$fromd' and ocode!='NC' and hotel_id='$hotelid' and booking_status!='Cancelled' $not_arr or  cin  between '$fromd' and '$tod' and ocode!='NC' and hotel_id='$hotelid' and booking_status!='Cancelled' $not_arr or   cin between date '$tod' - integer '30' and '$tod' and  cout > '$tod' and ocode!='NC' and hotel_id='$hotelid' and booking_status!='Cancelled' $not_arr order by cin";
...
?>
    ...
    <tr> 
      <td colspan="12"><div align="center"><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><strong>Allotment</strong></font></div></td>
      <?
$p=0;
for ($ja=0; $ja < $df ; $ja++) {
...
?>
    ...
    <tr> 
      <td colspan="12"><div align="center"><font color="#FF0000" size="2" face="Arial, Helvetica, sans-serif"><strong>Available</strong></font></div></td>
      <?
