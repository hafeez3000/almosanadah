...
<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
					  ...
					  <? if($suserid=="hafeez"){ ?>
					  <a href="../spr/amendspr.php"  target='amendspr' onClick="window.open('', 'amendspr' ,'width=775,height=450, directories=no,menubar=yes,scrollbars=yes,toolbar=no,resizable=no,fullscreen=no,titlebar=no,directories=no, top='+wint+',left='+winl+' ').focus()" >Amend Offers</a>
					  <? }?>
