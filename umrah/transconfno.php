...
$restransamenda = "INSERT INTO pnrhistory(user_sno, ocode, description, created_at) VALUES ('$suser_sno', '$s_pnr', 'Transportation Supplier Confirmation Number # ".$s_hot_rno."', 'now()')";
