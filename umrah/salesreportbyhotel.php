      ...
      <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Cout</font></div></td>
	        <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Nts</font></div></td>
				        <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Rooms</font></div></td>
										        <td><div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Room Nights</font></div></td>
...
$query  = "SELECT ocode,cin, cout,hotel_id, room_id,no_rooms,no_nights,cus_paid,booking_status,net_rate,sell_rate,room_inhouseno,hotel_confirmation_no,cus_voucher, guest_occ_status, cus_paid from sales_hotels where ocode!='NC' and $date_bulls between date '$fromd' and  date '$tod'  $not_arr  $q_hotel order by cin";
...
<td align="center"><font size="2" face="Arial, Helvetica, sans-serif"><?echo $row["no_nights"] * $row["no_rooms"]; ?> </font></td>
...
<tr><td colspan="7" align="center"> <font size="2" face="Arial, Helvetica, sans-serif">Totals</font> </td><td colspan="1" align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $tot_number_nights ; ?> </font></td><td colspan="1" align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $tot_number_rooms ; ?> </font></td><td colspan="1" align="center"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $tot_nofrn ; ?> </font></td><td colspan="2"><font size="2" face="Arial, Helvetica, sans-serif"><? echo "&nbsp;" ; ?></font> </td><td align="right"><font size="2" face="Arial, Helvetica, sans-serif"><? echo round($tot_net,2) ; ?> </font></td><td align="right"><font size="2" face="Arial, Helvetica, sans-serif"><? echo round($tot_sell,2) ; ?></font></td><td align="right"><font size="2" face="Arial, Helvetica, sans-serif"><? echo round($tot_sell-$tot_net,2) ; ?></font></td><td align="right"><font size="2" face="Arial, Helvetica, sans-serif"><? echo ($tot_net!=0) ? round(((($tot_sell-$tot_net)/$tot_net)*100), 2) : 0; ?></font></td></tr>
