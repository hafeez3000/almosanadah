...
$uphot = "update sales_visa set mofa_bull='$s_oc_bull',booking_status='Confirmed' where ocode='$s_pnr' and sales_visa_sno= $g_visaid ";
 pg_query($conn, $uphot);


//END - get hotel name for pnrhistory description
/*add a record to pnrhistory table*/
$hotelconfno = "INSERT INTO pnrhistory(user_sno, ocode, description, created_at) VALUES ('$suser_sno', '$s_pnr', 'MOFA is Granted', 'now()')";
...
$uphot = "update sales_visa set mofa_bull='$s_oc_bull',booking_status='On Request' where ocode='$s_pnr' and sales_visa_sno= $g_visaid ";
pg_query($conn, $uphot);
