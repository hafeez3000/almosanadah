...
<script src="salesreportbytcjs.js"></script>
<? $vy=$vm=$vd=0;
$vy1=$vm1=$vd1=0;
?>

<script>
document.title= '<? echo $company_name . " ERP - Sales Report by Transportation"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
      are here: <a href="uhome.php">Home</a> &raquo;  Reports &raquo; Sales Transportation by Country</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top">
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><strong>Sales Reports by Transportation</strong></td>
                    </tr></table>
                          ...
                          <form name="bbyod" method="post" action="#">
                            ...
                            <tr>
                              ...
                              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                ...
                                </font></td> <td align="left"> <input type="checkbox" name="cbc" id="cbc"> By Check-In Date &nbsp;<img src="../images/print_icon.gif""> <a href="printtansportreport.php" target="transreportpop" onclick="window.open('', 'transreportpop','width=775,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()">Print</a></td>
                            </tr>
                            <tr>
