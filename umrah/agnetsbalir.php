  ...
  <table border=1 cellpadding="2" cellspacing="0" align="center">
    <tr>
      <td colspan="6"> <div align="center"> <font size="3" face="Arial, Helvetica, sans-serif">
          <?
  echo "DORS ERP 2.0 - Ramadan 2007 Balance Payment - Agents wise List" ?>
          </font></div></td>
    </tr>
    <tr>
...
$query_sub  = "SELECT aname,country from agentsdet where acccode='$s_cus_ac' and country!='Morocco' and country!='Moracco' ";
...
?>
    <tr>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><a href="ramadan2007/agentwiseledger.php?agentacc=<? echo $s_cus_ac; ?>" target="popa" onClick="window.open('','popa', 'width=750,height=500,menubar=yes,scrollbars=yes,status=no top='+wint+',left='+winl+' ')" ><? echo strtoupper($c_name); ?></a></font></td>
