...
<script>
document.title= '<? echo $company_name . " ERP - Umrah Login"; ?>';
</script>
...
<table width="100%" >
  ...
  <tr>
    <td bgcolor="#D5FFD5" style="border-bottom: 1px solid #006600 ; border-top: 1px solid #006600"><div   style="width:35%; text-align: left; float: right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">To select other department :<a href="../index.php">Home</a></font></div></td>
  </tr>
</table>
<br>
<table width="100%"><tr><td><center>
	   ...
	   <form name="login" action="logina.php" method="post" onSubmit="return val(this)">
	    <table width="100%" align="center" >
                <tr>
                  <td colspan="2"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><font color="#416220" size="4" face="Arial, Helvetica, sans-serif">Welcome
                        to Umrah Department</font></font></div></td>
                </tr>
                <tr>
