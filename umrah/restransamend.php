...
<?
$q_trans_sel ="select sales_trans_sno,req_date_time,f2t,type_of_trans,no_of_units,no_of_paxs,flight_det,net_rate,sell_rate,tot_net_rate_tax,tot_sell_rate_tax,tot_net_rate,tot_sell_rate,booking_status,trans_id_s  from sales_trans where ocode='$s_pnr' and sales_trans_sno='$g_trans_sno'";
...
if($rows_trans>0){
echo "<br><table width=\"100%\" border=\"1\" cellpadding=\"1\" cellspacing=\"0\"><tr ><td bgcolor=\"#CCCCCC\"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Transportation</b></font></div></td><td colspan=\"11\"><div align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"></font></div></td></tr><tr bgcolor=\"#CCCCCC\"><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica,
sans-serif\"><b>From - To</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Units</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Type of Trans</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Date & Time</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana,
Arial, Helvetica, sans-serif\"><b>Flight Details</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>No of Paxs</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Total Net  Price</b></font></div></td><td><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Total Sell Price</b></font></div></td></tr>";
...
$s_net_rate = $rows_trans_sel["net_rate"];
$s_sell_rate = $rows_trans_sel["sell_rate"];
$s_tot_net_rate_tax = $rows_trans_sel["tot_net_rate_tax"];
...
<table width="100%" cellpadding="1" cellspacing="0">
                            ...
                            <td colspan="8">&nbsp;</td>
								   ...
								   <tr bgcolor="#CCCCCC">
                            <td colspan="10"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Transportation Sno : 1</font></td>
                          </tr>
					    <tr bgcolor="#FFFFFF">
                            <td colspan="10"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Transportation Supplier :
<?
...
<tr bgcolor="#EFEFEF">
                            ...
                            <td colspan="1" align="center" style="border-right: 1px solid #999999; border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Net Rate <br> per Unit</b></font></td>
                            <td colspan="1" align="center" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Sell Rate <br> per Unit</b></font></td>
                                 <td colspan="1" align="center" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>VAT Net</b></font></td>
                            <td colspan="1" align="center" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>VAT Sell</b></font></td>
...
$result_trans1_rates = pg_query($conn, $query_trans1_rates);
...
function trans1VatNet<? echo $s_typeoftrans0 ;?>(){ 
grand_net_vat(grand_gnt);
}
function trans1VatSell<? echo $s_typeoftrans0 ;?>(){ 
grand_sell_vat(grand_gt);
}
</script>
                            ...
                            <td colspan="1" align="center" style="border-bottom: 1px solid #999999;border-right: 1px solid #999999; border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="trans1nrate<? echo $s_typeoftrans0 ?>" name="trans1nrate<? echo $s_typeoftrans0 ?>" value='<?php if($trans1netr==0){ echo $s_net_rate;
 } else{echo $trans1netr * $s_noofu0 ;} ?>' size="3" style="text-align:right;" onKeyUp="trans1n<? echo $s_typeoftrans0 ?>()"  onFocus="trans1n<? echo $s_typeoftrans0 ?>()" onBlur="trans1n<? echo $s_typeoftrans0 ?>()"></font></td>
                            <td colspan="1" align="center" style="border-bottom: 1px solid #999999;border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="trans1rate<? echo $s_typeoftrans0 ?>" name="trans1rate<? echo $s_typeoftrans0 ?>" value='<? if($trans1sellr) {echo $trans1sellr * $s_noofu0;} else { echo $s_sell_rate;
} ?>' size="3" style="text-align:right;" onKeyUp="trans1<? echo $s_typeoftrans0 ?>()"  onFocus="trans1<? echo $s_typeoftrans0 ?>()" onBlur="trans1<? echo $s_typeoftrans0 ?>()"></font></td>
  <td colspan="1" align="center" style="border-bottom: 1px solid #999999;border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="vatNet<? echo $s_typeoftrans0 ?>" name="vatNet<? echo $s_typeoftrans0 ?>" value='<? echo $s_tot_net_rate_tax ?>' size="2" onKeyUp="trans1VatNet<? echo $s_typeoftrans0 ?>()"  onFocus="trans1VatNet<? echo $s_typeoftrans0 ?>()" onBlur="trans1VatNet<? echo $s_typeoftrans0 ?>()"></font></td>
                            <td colspan="1" align="center" style="border-bottom: 1px solid #999999;border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><input type="text" id="vatSell<? echo $s_typeoftrans0 ?>" name="vatSell<? echo $s_typeoftrans0 ?>" value='<? echo $s_tot_sell_rate_tax ?>' size="2" onKeyUp="trans1VatSell<? echo $s_typeoftrans0 ?>()"  onFocus="trans1trans1VatSell<? echo $s_typeoftrans0 ?>()" onBlur="trans1trans1VatSell<? echo $s_typeoftrans0 ?>()"></font></td>
...
var g_net=0 ;
g_net =  parseFloat(document.getElementById("trans1nrate<? echo $s_typeoftrans0 ?>").value);
document.getElementById("vatNet<? echo $s_typeoftrans0 ?>").value = g_net * 15 / 100;
g_net = g_net +  g_net * 15 / 100;
val.innerHTML = g_net * <?php echo $s_noofu0 ?>;
}
...
g_sell = parseFloat(document.getElementById("trans1rate<? echo $s_typeoftrans0 ?>").value);

document.getElementById("vatSell<? echo $s_typeoftrans0 ?>").value = g_sell * 15 / 100;

g_sell = g_sell + g_sell * 15 / 100; 

val.innerHTML = g_sell * <?php echo $s_noofu0 ?>;
}


function grand_net_vat(val){
g_net = parseFloat(document.getElementById("trans1nrate<? echo $s_typeoftrans0 ?>").value);
gvat_net = parseFloat(document.getElementById("vatNet<? echo $s_typeoftrans0 ?>").value);
g_net = g_net + gvat_net;
val.innerHTML = g_net  * <?php echo $s_noofu0 ?>;;

}

function grand_sell_vat(val){
g_sell = parseFloat(document.getElementById("trans1rate<? echo $s_typeoftrans0 ?>").value);
gvat_sell = parseFloat(document.getElementById("vatSell<? echo $s_typeoftrans0 ?>").value);
g_sell = g_sell + gvat_sell;
val.innerHTML = g_sell  * <?php echo $s_noofu0 ?>;
}
...
style="BACKGROUND-COLOR: #DFDFDF">Grand Net Total (with VAT 15%):</FONT> SAR <span id="grand_gnt">0</span>/-</font></td></tr>


<tr><td align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><FONT
style="BACKGROUND-COLOR: #DFDFDF">Grand Selling Total  (with VAT 15%):</FONT> SAR <span id="grand_gt">0</span>/-</font></td></tr>
