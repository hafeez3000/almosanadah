...
<table border="4" width="100%" height="113" bgcolor="#FFFFFF" bordercolor="#008000">
  <tr>
    <td width="40%" align="right" height="107" ><font size="4" face="Arial, Helvetica, sans-serif"><strong>
      <? echo $ar_company_name ; ?></strong></font>

      <p align="right"><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Dar Al Manasek Tourism &amp; Umrah</font></td>
      </td>
    <td width="20%" align="center" height="107"><img src="../images/logo.gif" width="56" height="56"></td>
    <td width="40%" align="left" height="107" ><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
