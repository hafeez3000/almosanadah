...
<br>
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-top: 1px solid #999999;">
<tr><td align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> Grand Total Price:  </font></td><td width="17%" style="border-bottom:  double #999999;"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><b><?echo $currency_s ;?>#<? echo number_format($g_tot, 2, "." , ",")?>/-</b></font></td></tr></table>

<br>
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
<tr><td align="justify"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">  <? echo date('D, jS M, Y H:i A', strtotime($s_option_date)); ?>  is option date for payment or for voucher, Kindly Transfer above Amount to A/C: Sohulat Al Safar Umrah Services, SASABB221547706001, SAB (Saudi Awwal Bank), Riyadh, Saudi Arabia, K.S.A </font></td></tr>
