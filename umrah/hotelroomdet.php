...
$hotelid_postv = $_POST["hotel"];

if($hotelid_postv=="select"){ $hotelid_postv = $_POST["hotelv"]; }

$s_wep="";
 

 $s_hotelsmad = $hotelid_postv;
...
$_SESSION["hotelsmad"] = $hotelid_postv;

if(isset($_POST["ch_wep"]) && $_POST["ch_wep"]=="on"){
...
checked = theForm.querySelectorAll("input[type=checkbox]:checked").length;
  if (!checked) {
...
<form name="gquot" action="hotelroomrate.php"  method="post" onSubmit="return validateForm(this)">
...
if(isset($status) && $status==1 && $avail_bullt=="t" && min($avail_rooms)>0 ){

//echo "<td>A</td>";
echo "<td align=\"center\" style=\" border-right: 1px solid #999999; border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>&nbsp;</strong></font></td><td align=\"center\" style=\" border-right: 1px solid #999999; border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><strong>&nbsp;</strong></font></td><td align=\"center\" style=\"border-right: 1px solid #999999; border-bottom: 1px solid #999999\"><input type=\"checkbox\" name=\"madselrcb[]\" id=\"madselrcb$s_roid\" value=\"$s_roid\"></td><td align=\"center\" style=\"border-right: 1px solid #999999; border-bottom: 1px solid #999999\">";
