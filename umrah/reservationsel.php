...
$mad_result_main = pg_query($conn, $mad_query_main);
if (!$mad_result_main) {
	echo "An error occured.\n";
	exit;
	}
...
$mak_result_rates = pg_query($conn, $mak_query_g_rates);
...
$mak_result_main = pg_query($conn, $mak_query_main);
if (!$mak_result_main) {
	echo "An error occured.\n";
	exit;
	}
...
$oth_result_rates = pg_query($conn, $oth_query_g_rates);
...
$oth_result_main = pg_query($conn, $oth_query_main);
if (!$oth_result_main) {
	echo "An error occured.\n";
	exit;
	}
...
$result_trans2_rates = pg_query($conn, $query_trans2_rates);
...
$result_trans3_rates = pg_query($conn, $query_trans3_rates);
...
$result_trans4_rates = pg_query($conn, $query_trans4_rates);
