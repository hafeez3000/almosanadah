...
<script src="salesreportbyhdjs.js"></script> 
<? $vy=$vm=$vd=0; 
$vy1=$vm1=$vd1=0;
?>

<script>
document.title= '<? echo $company_name . " ERP - Sales Report by Hotel per Day Wise"; ?>';
</script>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><strong>Sales Reports by Hotel by Day Wise</strong></td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0" ><tr>
                      <td> 
                       ...
                       <!--     <tr> 
                           ...
                           -->     
								</font></td> <td align="left"> <input type="checkbox" name="cbc" id="cbc" disabled> 
								<!--
								By Check-In Date -->
