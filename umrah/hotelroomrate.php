                              ...
                              <table width="100%" border="0" cellspacing="0">
                                <tr>
                                  <td>
                                    ...
                                    <form name="roomselput" action="hotelsel.php" method="post"
...
//echo $day_room_ntot = $ridn * $array_sel_rooms[$ri] ;
                                            ...
                                            echo "<tr><td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Hotel Room(s) Total <FONT 
style=\"BACKGROUND-COLOR: #DFDFDF\">NetRate:</FONT> SAR <span id=\"mad_gnt\">0</span>/-</font></td></tr>";


                                            echo "<tr><td align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Hotel Room(s) Total <FONT 
style=\"BACKGROUND-COLOR: #DFDFDF\">SellingRate:</FONT> SAR <span id=\"mad_gt\">0</span>/-</font></td></tr>";
                                ...
                                <tr>
                                  <td colspan="2" align="center"><input type="submit" value="Get Selected Rooms Price">
                                  </td>
                                </tr>
