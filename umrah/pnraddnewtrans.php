      ...
      <td bgcolor="#CCCCCC">
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
          are here: <a href="uhome.php">Home</a> &raquo; <a href="bookings.php">Bookings</a> &raquo; <a
            href="newbookings.php">New Bookings</a> &raquo; New Transportation Booking</a></font>
      </td>
    </tr>
  </table>
...
//$vd1=date('d', strtotime($s_req_date_time));
                    ...
                    <form name="gquot" action="resaddtranspnr.php" method="post" onSubmit="return fun2(this)">
                      ...
                      <table width="100%" align="left" style="border: 1px solid #673636" cellpadding="5"
                        cellspacing="0">
                        <tr bgcolor="#E8D2D2">
                        ...
                        <tr>
                          ...
                          <td>
                            <div align="right">
                              <font size="2" face="Arial, Helvetica, sans-serif">Time</font>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div align="right">
                              <font size="2" face="Arial, Helvetica, sans-serif">Supplier</font>
                            </div>
                          </td>
                          <td colspan="3">
                            <font size="2" face="Arial, Helvetica, sans-serif"><strong>
                                <select id="s_trans0" name="s_trans0">
                                  ...
                                  for ($i = 0; $i < count((array) $array_trans_id); $i++) {
                        ...
                        <tr>
                          <td>
                            <div align="right">
                              <font size="2" face="Arial, Helvetica, sans-serif">Type
                          ...
                          <td colspan="3">
                            <font size="2" face="Arial, Helvetica, sans-serif"><strong>
                                <select id="typeoftrans0" name="typeoftrans0">
                                  ...
                                  for ($i = 0; $i < count((array)$array_transt_id); $i++) {
                        ...
                        <tr>
                          <td>
                            <div align="right">
                              <font size="2" face="Arial, Helvetica, sans-serif">Flight
                                Details</font>
                            </div>
                          </td>
                          <td>
                          ...
                          <td>
                            <div align="right">
                              <font size="2" face="Arial, Helvetica, sans-serif">No. Units</font>
                            </div>
                          </td>
                          <td>
                            <font size="2" face="Arial, Helvetica, sans-serif">
