...
<input type="hidden" name="g_hot" value='<? echo $s_hotelsb1 ;?>'>
                                 ...
                                 <input type="checkbox" id="inscb" name="inscb" unchecked onClick="sameas();" onBlur="sameas();" onFocus="sameas();"><input type="submit" name="Submit" value="Amend Hotel Rates >>" disabled></td>
                            </tr>
                          </form>
                        </table>
                         </td>
