...
$query_main ="select main_sno,ocode,guest_title,guest_name,guest_nationality,guest_telno,guest_notes,flight_det,cus_account_code,cus_title,cus_name,cus_company_name,cus_country,agent_notes,group_code from sales_main where ocode='$s_pnr'";
...
<table width="100%" bgcolor="#00A800" cellpadding="0" cellspacing="0"><tr>
...
<form name="finalize" method="post" action="amendguestdeta.php" style="margin-top: 1px; margin-bottom: 0px"   x-data="form()" @submit.prevent="if (!message && fun2(this)) $el.submit()">
 ...
 <script type="text/javascript">
   ...
   if ( (document.finalize.a_search.value == null) ||  ((document.finalize.a_search.value).length==0))
   {
	  ...
	  document.finalize.a_search.focus();
        ...
        <?
  echo  "<option value=\"$s_cus_account_code\">$s_cus_company_name - $s_cus_country</option>";
	...
	?>
                                  ...
                                  <tr> 
                                    ...
                                    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
									 ...
									 <?   echo  "<option value=\"$s_cus_title\">$s_cus_title</option>";
                                       ?>
                                  ...
                                  <tr> 
                                    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Contact 
                                      Person Name</font></td>
                                    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                                      <input type="text" id="cpname" name="cpname" size="50" value='<? echo $s_cus_name ?>'>
                                      <img src="../images/icon_redStar.gif" width="10" height="10" align="top"> 
                                      </font></td>
                                  </tr>
                                  <tr> 
                                    ...
                                    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                                      <input type="text" name="tanotes" size="50" value='<? echo $s_agent_notes ?>'>
                                      </font></td>
                                  </tr>
...
<tr> 
                                    ...
                                    <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                                    <input type="text" id="gnationality" name="gnationality" size="50"  value='<?php echo $s_guest_nationality ?>'>
                                      <img src="../images/icon_redStar.gif" width="10" height="10" align="top"> 
                                      </font></td>
                                  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CAFFCA"><tr>
  ...
  <input type="submit" name="Submit" value="Amend Agent/Guest Details >>>">&nbsp;
