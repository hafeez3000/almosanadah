...
$hot_supp_chk = pg_query($conn, $q_supp_chk);
...
if(trim((string)$s_fax[$i])==""){echo " &nbsp; <br> &nbsp; ";}
else{
echo "Fax: "  . $s_fax[$i];
}
...
$r_sno=1;
$q_hotel_sel ="select sales_hotels_sno,user_sno,hotel_id,room_id,cin,cout,no_rooms,no_nights,no_paxs,sell_rate,booking_status  from sales_hotels where hotel_id='$a_hotel_id[$i]' and ocode='$s_pnr' order by cin";
...
if($s_breakfast=="N/A" && $s_halfboard=="N/A" && $s_fullboard=="N/A" && $s_sahoor=="N/A" && $s_iftar=="N/A"){
$p_meals = "";
$p_meals = "Room Only";
}
...
$r_sno=1;
$q_hotel_sel ="select sales_hotels_sno,user_sno,hotel_id,room_id,cin,cout,no_rooms,no_nights,no_paxs,sell_rate,booking_status  from sales_hotels where supp_id='$a_supp_id[$i]' and ocode='$s_pnr' order by cin";
...
$hot_supp_2chk = pg_query($conn, $q_supp_2chk);
