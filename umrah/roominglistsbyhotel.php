...
<script>
document.title= '<? echo $company_name . " ERP - Rooming Lists"; ?>';
</script>
<script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      are here: <a href="uhome.php">Home</a> &raquo;  Reports &raquo; Rooming Lists</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Rooming Lists by Hotel</strong></td>
                    </tr></table>
                          ...
                          <form name="bbyod" method="post" action="#">
                            ...
                            <tr> 
                              ...
                              <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                               ...
                               <input type="checkbox" id="onrequest" name="onrequest" checked >On Request &nbsp;
							   <input type="checkbox" id="onrequest" name="onrequest" checked >							   Confirmed 

                                </font> </font></td>
                            </tr>

                              <tr> 
                              <td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Paid Status </font></div></td>
                              <td><font size="2" face="Arial, Helvetica, sans-serif"> 
                                <font size="2" face="Arial, Helvetica, sans-serif">
                               <input type="checkbox" id="paid" name="paid"  checked>Paid &nbsp;
							   <input type="checkbox" id="npaid" name="npaid" checked >Not Paid
	...
	?>
                            ...
                            <tr> 
                              <td colspan="1"><div align="left"> 
                                  <input type="button" name="print_rl" id="print_rl" value="Print Rooming List for Hotel" onClick="p_rl();">

								  								<input type="button" name="print_rl" id="print_rl" value="RL with No. Rooms" onClick="p_rlw();">
...
var to_d = t_year+"-"+t_month+"-"+t_day;
 ...
 var pd_amtt = "roomlistbyhotelpforh.php?vt="+fv+"&f_d="+from_d+"&t_d="+to_d;
	

window.open( pd_amtt , 'hotdetvou','width=775,height=200, directories=no,menubar=yes,scrollbars=yes,toolbar=no,resizable=no,fullscreen=no,titlebar=no,directories=no, top='+wint+',left='+winl+' ').focus()
...
var to_d = t_year+"-"+t_month+"-"+t_day;
 ...
 var pd_amtt = "roomlistbyhotelpforhw.php?vt="+fv+"&f_d="+from_d+"&t_d="+to_d;
