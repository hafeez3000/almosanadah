...
<?
$q_trans_sel ="select sales_trans_sno,req_date_time,f2t,type_of_trans,no_of_units,no_of_paxs,flight_det,sell_rate,tot_sell_rate,booking_status,trans_id_s,trans_supplier_confirmation,cus_voucher,cus_paid,occp_bull,room_inhouseno  from sales_trans where ocode='$s_pnr' and sales_trans_sno=$g_trans_sno";
...
$guest_roomno = $rows_trans_sel["room_inhouseno"];
...
<?php if (!empty($s_pnr)) {
    ...
    while ($pgfapnr = pg_fetch_array($pgqpnr)) {
        ...
        $pnrusername =
            $pgfapnr["user_first_name"] . " " . $pgfapnr["user_last_name"];
		...
		document.location.href=hotno ;
								...
								<tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
									...
									value='<? echo $trans_supplier_confirmation ; ?>' size="10"><br>
		...
		document.location.href=ag_vn ;
                                ...
                                <tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
									...
									value='<? echo $cus_voucher ; ?>' size="10">
...
'<? echo "&transid=".$g_trans_sno ?>'+"&pd_amt="+document.getElementById ("pd_amt").value;
		document.location.href=pd_amtt ;
                                ...
                                <tr>
                                  ...
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">
                                    <input type="text" id="pd_amt" name="pd_amt" value='<? echo $cus_paid ; ?>' size="10">
...
'<? echo "&transid=".$g_trans_sno ?>'+"&rm_no="+document.getElementById ("rm_no").checked;
   ...
   if ((document.getElementById ("rm_rnot").value== null) || ((document.getElementById ("rm_rnot").value).length==0))
   {
      alert ("Sorry, But enter Hotel Room Number");
	  document.getElementById ("rm_rnot").focus();
   }
   else {
         var ag_vn = "guestinhnot.php?"+'<? echo "spnr=".$s_pnr ?>'+
'<? echo "&transid=".$g_trans_sno ?>'+"&guest_rno="+document.getElementById ("rm_rnot").value;
		document.location.href=ag_vn ;
                                ...
                                <tr>
                                  <td style="border-bottom: 1px solid red" align="left">Guest Hotel Room Number                                  </td>
                                  <td style="border-bottom: 1px solid red" align="left"><div align="left">

									<input type="text" id="rm_rnot" name="rm_rnot" value='<? echo $guest_roomno ; ?>' size="10">
                                    <br><input type="button" id="rm_rno" name="rm_rno" value="Hotel Room No" onClick="guest_rno()">
                                  </div></td>
                                </tr>
