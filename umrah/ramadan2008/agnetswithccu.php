...
$tot_b=0;
 ...
 $query  = "SELECT cus_account_code from sales_hotels where cout between  date '$tod' - integer '30'  and '$tod' and cout > '$fromd' and ocode!='NC' and booking_status!='Cancelled' and cus_account_code between 150900 and 159999 or  cin  between '$fromd' and '$tod' and ocode!='NC'  and booking_status!='Cancelled' and cus_account_code between 150900 and 159999 or   cin between date '$tod' - integer '30' and '$tod' and  cout > '$tod' and ocode!='NC' and booking_status!='Cancelled' and cus_account_code between 150900 and 159999 group by cus_account_code order by cus_account_code";
  ...
  <table border=1 cellpadding="2" cellspacing="0" align="center">
    <tr> 
      <td colspan="6"> <div align="center"> <font size="3" face="Arial, Helvetica, sans-serif"> 
          <?
  echo "DORS ERP 2.0 - Ramadan 2009 Balance Payment - Only Umrah Agents" ?>
          </font></div></td>
    </tr>
    <tr> 
