...
while ($totrow = pg_fetch_array($totresult))
 ...
 if($fbaldb>0) { echo number_format(round(($fbaldb*100/100),2), 2, "." , ",");  return $r_balt = $fbaldb ; }

 else if($fbalcr>0){echo "-" . number_format(round(($fbalcr*100/100),2), 2, "." , ","); return $r_balt = -$fbalcr;}

else{echo "0.00"; return $r_balt = 0.0;}
