...
<script src="salesreportbyhjs.js"></script> 
<? $vy=$vm=$vd=0; 
$vy1=$vm1=$vd1=0;
?>

<script>
document.title= '<? echo $company_name . " ERP - Sales Report by Hotel"; ?>';
</script>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999" ><tr>
                      <td bgcolor="#CCCCCC"><strong>Sales Reports by Hotel</strong></td>
                    </tr></table>
<table width="100%" cellpadding="1" cellspacing="0" ><tr>
                          ...
                          <form name="bbyod" method="post" action="#">
                            ...
                            <tr> 
                              ...
                              <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                                ...
                                </font></td> <td align="left"> <input type="checkbox" name="cbc" id="cbc"> By Check-In Date  &nbsp;<img src="../images/print_icon.gif""> <a href="printhotelreport.php" target="hotreportpop" onclick="window.open('', 'hotreportpop','width=775,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()">Print</a></td>
                            </tr>
                            <tr> 
		...
		<option value="makkahex">Makkah Hotels Except Tawhid,Hilton,Towers</option>
		<option value="madinah">Madinah Hotels</option>
     	<option value="kingdom">All Kingdom Hotels</option>
        <?
