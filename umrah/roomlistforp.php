...
?>
	...
	<td><font size="2" face="Arial, Helvetica, sans-serif"><?echo strtoupper($row_sub["guest_name"]); ?></font></td>
      ...
      <td><font size="2" face="Arial, Helvetica, sans-serif"><?echo $room_type; ?></font></td>
		...
		<td><font size="2" face="Arial, Helvetica, sans-serif"><? if(isset($row_sub["cus_voucher"]) && $row_sub["cus_voucher"]!=""){ echo $row_sub["cus_voucher"];} else { echo "&nbsp;" ; }?></font></td>

		<td><font size="2" face="Arial, Helvetica, sans-serif"><?  if(isset($row_sub["hotel_confirmation_no"]) && $row_sub["hotel_confirmation_no"]!=""){ echo $row_sub["hotel_confirmation_no"]; } else { echo "&nbsp;" ;} ?></font></td>

		<td><font size="2" face="Arial, Helvetica, sans-serif"><?		
		if(isset($row_sub["room_inhouseno"]) && $row_sub["room_inhouseno"]==""){ echo $row_sub["room_inhouseno"];} else { echo "&nbsp;" ; }
		?></font></td>		
