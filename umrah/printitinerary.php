...
<html>
<head><title>Sohulat Al Safar Umrah Services - Itinerary</title>
...
<tr>
<td  align="center" ><font face="Arial, Helvetica, sans-serif"><strong><?php echo $s_online ?><?php if($s_main_booking_status=="Confirmed"){ echo "DEFINITE"; } else { echo "TENTATIVE"; } ?> BOOKING ITINERARY </strong></font></td>
...
echo "</font></div></td><td ><div align=\"left\" style=\"padding-left:5px\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">  Rooms:" . $s_no_of_rooms . "X Nights: $j"  ."</font></div></td>";
...
echo "<tr><td colspan=\"2\" style=\"border-bottom: 1px dotted #999999;\"><div align=\"left\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"></font></td><td colspan=\"2\" style=\"border-bottom: 1px dotted #999999;\"><div align=\"right\"><font size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\"></font></div></td>";
echo "</tr>";
...
if($rows_trans>0){
echo "<table width=\"95%\" border=\"0\" cellpadding=\"2\" cellspacing=\"0\" align=\"center\"><tr><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">From - To</font></div></td><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Units</font></div></td><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Type of Trans</font></div></td><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Date & Time</font></div></td><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Flight Details</font></div></td><td style=\"border-top: 1px solid #999999;border-right: 1px solid #999999;border-bottom: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Paxs</font></div></td></tr>";
...
if($rows_visa>0){
echo "<table width=\"95%\" border=\"0\" cellpadding=\"2\" cellspacing=\"0\" align=\"center\"><tr><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Visa Request Date</font></div></td><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Total Paxs</font></div></td><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Adults</font></div></td><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Child</font></div></td><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Infant</font></div></td></tr>";
}
...
if($rows_extra>0){
echo "<table width=\"95%\" border=\"0\" cellpadding=\"2\" cellspacing=\"0\" align=\"center\"><tr><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Request Date</font></div></td><td style=\"border-bottom: 1px solid #999999;border-right: 1px solid #999999;border-top: 1px solid #999999 \"><div align=\"center\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Paticulars</font></div></td></tr>";
}
...
<?php
$mandoop_det ="select mandoop_name, mandoop_branch, mandoop_mobile from mandoop where mandoop_status='t' ";

$mandoop_sel = pg_query($conn, $mandoop_det);
if (!$mandoop_sel) {
echo "An error occured.\n";
exit;
		}
...
?>
<table width="95%" border="0" style="border: 1px solid #999999" cellspacing="0" cellpadding="0" align="center">
<tr>
<td align="justify" colspan="3"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Service Agent Details
 </b></font> </td>
</tr>
<tr>
<td align="justify" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b> Agent Name</b></font> </td>
<td align="justify" style="border-top: 1px solid #999999" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b> Branch</b></font> </td>
<td align="justify" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Mobile
 </b></font> </td>
</tr>
<?php
}

while ($rows_mandoop = pg_fetch_array($mandoop_sel)){

?>
<tr>
<td align="justify" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><i> <? echo $rows_mandoop["mandoop_name"]; ?></i></font> </td>
<td align="justify" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><i> <? echo $rows_mandoop["mandoop_branch"];
 ?></i></font> </td>
<td align="justify" style="border-top: 1px solid #999999"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><i> <? echo $rows_mandoop["mandoop_mobile"];
 ?></i></font> </td>
...
$q_u_det ="select user_first_name, user_last_name from users where user_sno='$s_h_user_id'";
