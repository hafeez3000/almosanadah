    ...
    <tr>
      <td bgcolor="#CCCCCC">
        <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
          are here: <a href="uhome.php">Home</a> &raquo; <a href="bookings.php">Bookings</a> &raquo; <a
            href="newbookings.php">New Bookings</a> &raquo; New Hotel Booking</a></font>
      </td>
    </tr>
  </table>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
          <tr>
            <td valign="top">
              ...
              $query_hotel = "select hotel_id, hotel_name from hotels where account_code!='0' order by hotel_name";
                ...
                <tr>
                  <td width="85%" valign="top">
                    <table cellpadding="0" cellspacing="0" width="100%"
                      ...
                      <tr>
                        <td bgcolor="#CCCCCC"><strong>New Hotel Booking </strong>- Select Hotel </td>
                      </tr>
                    </table>
                          ...
                          <div align="left">
                            <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                              <table width="100%" border="0" cellspacing="0">
                                ...
                                <tr bgcolor="#CCCCCC">
                                  <td colspan="4">
                                    <form name="selhotel" method="post" action="resaddhotpnr.php"
                                      onSubmit="return fun2(this)">
                                ...
                                <tr bgcolor="#EFEFEF">
                                  <td colspan="3">
                                    <table align="center">
                                      <tr>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Check-In</font>
                                        </td>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                      ...
                                      <tr>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Check-Out&nbsp;
                                          </font>
                                        </td>
                                        <td>
                                          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
                                ...
                                <tr>
                                  <td colspan="2" align="center">
                                    <font size="2" face="Verdana, Arial, Helvetica, sans-serif">WeekEnd Package </font>
                                    <input type="checkbox" id="ch_wep" name="ch_wep" checked>
                                  </td>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td bgcolor="#DFFFDF">
                                    <div align="center"><strong>
                                        <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Hotel</font>
                                      </strong></div>
                                  </td>
                                </tr>
                                <tr align="center">
                                  ...
                                  <td bgcolor="#EFEFEF">
                                    ...
                                    <select id="hotel" name="hotel" onFocus="assv();" onBlur="assv();"
                                      onChange="assv();">
                                ...
                                <tr>
                                  <td colspan="4">
                                    <div align="center">
                                      <font size="2" face="Verdana, Arial, Helvetica, sans-serif">OR</font>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="4" bgcolor="#EFEFEF" align="center"> Enter the Hotel Name :<input
                                      type="text" id="hotelname" name="hotelname" onFocus="subdis()"
                                      onKeyPress="return noenter()"> <input type="button" name="searchhotel"
                                      value="search" onClick="OpenWindow()"></td>
                                </tr>
            ...
            <td width="15%" style="border-left: 1px solid #999999">
              <table>
                <tr>
                  ...
                  $days = [
                      $today => [
                          null,
                          null,
                          '<span style="color: red; font-weight: bold; font-size: larger; text-decoration: none;">' .
                          $today .
                          "</span>",
                      ],
                  ];
