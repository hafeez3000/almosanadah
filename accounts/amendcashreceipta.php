...
$petq ="update pettyvou set dbamt=0, cramt=$s_amount, recfrom='$s_paidto', description='$s_beingp', voudate='$s_voudate', statementno=$s_refno, inw='$s_inw' where typeofv='$s_voutype' and vounum='$s_vouno'";
...
$insq2 = "update vocmast set vocdate='$s_voudate',narration='$s_paidto',moredet='$s_beingp',dbamt=$s_amount,cramt=0,recon='f' where voctype='$s_voutype' and vocno='$s_vouno' and acccode='102001'";

pg_query($conn, $insq2);


$insq = "update vocmast set vocdate='$s_voudate',acccode='$s_accode',narration='$s_paidto',moredet='$s_beingp',dbamt=0,cramt=$s_amount,recon='f' where voctype='$s_voutype' and vocno='$s_vouno' and acccode!='102001'";
