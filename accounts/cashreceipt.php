...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Cash Receipt Voucher"; ?>';
</script>
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="cashreceipta.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF">&nbsp;<strong>New Cash Receipt Voucher</strong>                                 </td>
                                </tr>
...
alert("Sorry, But Enter the details of the purpuse of receiving");
return false;
}
