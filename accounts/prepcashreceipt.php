  ...
  <tr>
	...
	<table style="border: 1px solid red" width="100%" >
	 <tr>
                                  ...
                                  <td bgcolor="#FFDFDF">&nbsp;<strong>New Cash Receipt Voucher</strong>                                 
								  <a href="printcashrvou.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashrpayment" onClick="window.open('', 'pcashrpayment','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16"></a>
...
<tr><td>&nbsp;</td><td align="right" ><b>Cash Amount SAR : <? echo $s_dbamt ;?>/-</b></td></tr>
	...
	<tr><td  style="border-bottom: 1px dashed red;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>For: <? echo $s_description ;?></font></td></tr>		  
