...
$q_hotel_pe ="select typeofv,vounum,recfrom,cramt,description,voudate,statementno,inw  from pettyvou where typeofv='$voc_t' and vounum='$voc_no'";
...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Amend Cash Receipt Voucher"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 3px solid #006600; border-right: 3px solid #006600;border-left: 3px solid #006600 ">
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="amendcashreceipta.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF">&nbsp;<strong>Amend Cash Receipt Voucher</strong>                                 </td>
                                </tr>
       <tr><td align="center"><img src="../images/letterheadb.jpg"></td></tr>

	 <tr>
      <td align="center"><font size="3" face="Arial,Verdana,Helvetica, sans-serif"><strong>Cash Receipt Voucher</strong></font>                                 <br><br></td>
     </tr>
	...
	<tr>
	  <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Voucher Type</font>
	    ...
	    &nbsp;&nbsp;<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Voucher No</font><input type="text" id="vouno" name="vouno" value=<? echo $s_vounum ?> size="10" ></td>
  ...
  </table> <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Statement No</font> <input type="text" id="refno" name="refno" size="2" value="<? echo $s_statementno ;?>"></td>
...
<script type="text/javascript">
   ...
   echo  "<option value=\"$array_acccode[$i]\">$array_acc_name[$i] - $array_acccode[$i]</option>";
	...
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Received<br> from : &nbsp;</font> <input type="text" id="paidto" name="paidto" size="85" value="<? echo $s_paidto ;?>">	  </td></tr>	
...
function TryVal() {
  ...
  TryNo %= Tries.length }
	...
	<tr><td><br><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Amount:</font> <input type="text" id="camt" name="camt" value="<? echo $s_dbamt ; ?>" size="5" onKeyUp="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }">	  /-</td></tr>	
