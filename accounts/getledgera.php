...
$s_ac = isset($_POST["accode"]) ? $_POST["accode"] : "";
...
$madcind = isset($_POST['dDay']) ? $_POST['dDay'] : "";
$madcinm = isset($_POST['dMonth']) ? $_POST['dMonth'] : "";
$madciny = isset($_POST['dYear']) ? $_POST['dYear'] : "";

$madcin = $madciny ."-". $madcinm ."-". $madcind ; 
$fromd = $madciny ."-". $madcinm ."-". $madcind ; 

$madcoutd = isset($_POST['d1Day']) ? $_POST['d1Day'] : "";
$madcoutm = isset($_POST['d1Month']) ? $_POST['d1Month'] : "";
$madcouty = isset($_POST['d1Year']) ? $_POST['d1Year'] : "";
...
?>
 <tr>
     <td bgcolor="#FFDFDF" colspan="4"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"> <strong><?echo $acc_name ?> Ledger  </strong></font></td> <td colspan="3" bgcolor="#FFDFDF" align="left">
	...
	?>
	<a href="agentledgerexcel.php?acc=<? echo $s_ac; ?>&fd=<?echo $madcin ?>&td=<? echo $madcout ?>">ExcelExport</a>
	<a href="printledgerpnrwise.php?acc=<? echo $s_ac; ?>&fd=<?echo $madcin ?>&td=<? echo $madcout ?>" target="pledgerpnrwise" onClick="window.open('', 'pledgerpnrwise','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()">PNR wise Ledger</a>&nbsp;&nbsp;&nbsp;&nbsp;

	<?

         echo "<img src=\"../images/mail_icon.gif\" onClick=\"send_m()\" align=\"center\" >";
		 ...
		 echo "&nbsp;&nbsp;&nbsp;";
            ...
            ?>
	<a href="nonagentledgerexcel.php?acc=<? echo $s_ac; ?>&fd=<?echo $madcin ?>&td=<? echo $madcout ?>">ExcelExport</a>
	...
	<?
		 ...
		 ?>
                          ...
                          <a href="printledger.php?acc=<? echo $s_ac; ?>&fd=<?echo $madcin ?>&td=<? echo $madcout ?>" target="pledger" onClick="window.open('', 'pledger','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16" align="center"></a> </font></td>
                                </tr>
 ...
 <tr>
     <td colspan="7"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> <?echo "Account Code: " .$acccode ." - Account Name: ". $acc_name . ", Country: " . (isset($a_scountry) ? $a_scountry : '') . "<br>Tel: " . (isset($a_tel1) ? $a_tel1 : '') . ", Fax: " . (isset($a_fax) ? $a_fax : '') . ", Email: " . (isset($a_email) ? $a_email : '') ?>  </font>                            </td>
                                </tr>
<tr>
