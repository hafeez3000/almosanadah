...
$petq ="insert into pettyvou(typeofv, vounum, dbamt,cramt, paidto, description, voudate, statementno,inw,amendbull ) VALUES ('$s_voutype','$s_vouno',$s_amount,0,'$s_paidto','$s_beingp','$s_voudate',$s_refno,'$s_inw','t')";
