  ...
  <tr>
	...
	<table style="border: 1px solid red" width="100%" >
	 <tr>
                                  ...
                                  <td bgcolor="#FFDFDF">&nbsp;<strong>New Cash Payment Voucher</strong>
								  <a href="printcashvou.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpayment" onClick="window.open('', 'pcashpayment','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16"></a>
