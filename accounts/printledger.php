...
$a_supp_inv[] = $rows_voc["supp_inv"];
 ...
 <tr>
  ...
  <tr>
     <td colspan="7"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> <?echo "Account Code: " .$acccode ." - Account Name: ". $acc_name . ", Country: " . $a_scountry . "<br>Tel: " . $a_tel1 . ", Fax: " . $a_fax . ", Email: " . $a_email ?>  </font>                            </td>
                                </tr>
<tr>
...
?>
<tr><td style="border-top: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black" colspan="7" align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><br>Balance Amount Due: <b><? echo $bala ?> </b> /-&nbsp;<? echo $currency_s ?><br><br> Beneficiary Name : Sohulat Al Safar Umrah Services<BR>
