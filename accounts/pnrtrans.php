...
$query_voc ="select voctype,vocno,vocdate,acccode,narration,dbamt,cramt,pnr,moredet,supp_inv from vocmast where voctype='$s_act' and invno='$s_minv' order by  vocno,voctype,vocsno";
