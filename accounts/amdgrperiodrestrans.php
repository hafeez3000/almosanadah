...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You
      ...
      &raquo; Transportation Rates Amend</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top">
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Reservation Transportation Rates Amend</strong></td>
                    </tr></table>
...
$query_g_rates ="select rate_sno,trans_id,from_date,to_date,net_rate,sell_rate,nationality  from res_trans_rates where trans_id like '$s_hotelsb%' order by trans_id";
...
?>
                          <form name="gquot" action="amdgrperiodrestransa.php"  method="post" onSubmit="return fun2(this)">
                            <tr>
                              <td colspan="5">&nbsp;</td>
                            </tr>
                            <tr bgcolor="#CCCCCC">
                              <td colspan="5"><img src="../images/car-icon.gif" width="23" height="14" align="absmiddle">&nbsp;Transportation Rates Amend
                             </td>
                            </tr>
  ...
  echo  "<tr><td style=\"border-bottom: 1px solid #999999;\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">$array_rooms[$i]</font></td><td align=\"center\" style=\"border-bottom: 1px solid #999999;\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">$array_route[$i]</font></td><td style=\"border-bottom: 1px solid #999999;\" align=\"center\"> <input type=\"text\" id=\"weekdayn$array_room_id[$i]\" name=\"weekdayn$array_room_id[$i]\" size=\"1\" value=\"$arr_weekday_net[$i]\"><INPUT TYPE=\"button\"  id=\"weekdaynb$array_room_id[$i]\" name=\"weekdaynb$array_room_id[$i]\" VALUE=\"+\" onClick=\"add$array_room_id[$i]()\" >&nbsp;<input type=\"text\" id=\"weekdays$array_room_id[$i]\" name=\"weekdays$array_room_id[$i]\" size=\"1\" value=\"$arr_weekday_sell[$i]\"><INPUT TYPE=\"button\"  id=\"weekdaysb$array_room_id[$i]\" name=\"weekdaysb$array_room_id[$i]\" VALUE=\"c\" onClick=\"caln$array_room_id[$i]()\" ></td></tr>";
...
<input type="hidden" name="g_hot" value='<? echo $s_hotelsb1 ;?>'>
                                 ...
                                 <input type="checkbox" id="inscb" name="inscb" unchecked onclick="sameas();" onchange="sameas();"><input type="submit"  id="Submit" name="Submit" value="Amend Hotel Rates >>" disabled></td>
                            </tr>
                          </form>
                        </table>
                         </td>
