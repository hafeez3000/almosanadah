...
$wob = isset($_POST["withob"]) ? $_POST["withob"] : "";



?>
		  <table width="100%" border="0" cellpadding="1" cellspacing="0">
		  <tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Profit and Loss <br>from: &nbsp; <? echo date('D, d-M-Y', strtotime($fromd))  ." to " . date('D, d-M-Y', strtotime($tod)) ?></b></font>


		   <a href="printpl.php?fd=<? echo $fromd ?>&td=<? echo $tod ?>&wob=<? echo $wob ?>" target="ppl" onClick="window.open('', 'ppl','width=760,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16"></a>
&nbsp;&nbsp;

<img src="../images/3dpie.bmp" width="16" height="16" onClick="ppg()">
...
<tr>
<td colspan="3"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Income</font></div></td>
...
<tr>
<td colspan="3"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Expenses</font></div></td>
...
<tr>
<td colspan="3"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Profit in SAR</font></div></td>
<td><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><? echo number_format($gtotcr-$gtotdb, 2, "." , ",") ?></strong></font></div></td>
</tr>

<tfoot style="display:table-footer-group;"><tr><td colspan="4" style="border-top: 1px solid #999999" align="right">End of the Page</td></tr></tfoot>
  </table>
...
<script>
function ppg(){
window.open('printplgraph.php?income=<? echo $gtotcr; ?>&expense=<? echo $gtotdb; ?>', 'printplgraph','width=760,height=400,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus();
}
</script>
