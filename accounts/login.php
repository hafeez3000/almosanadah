...
<STYLE>
table.first {
	background-image: url(../images/gradient_green_200.jpg);
...
<script>
document.title= '<? echo $company_name . " ERP - Accounts Login"; ?>';
</script>

<table width="100%" >
  <tr>
    <td><div align="center"><img src="../images/logo.jpg"  height="56"></div></td>
  </tr>
  <tr>
    <td><div align="center"><img src="../images/arname.jpg"></div></td>
  </tr>
  <tr>
...
<table width="100%" ><tr><td><center>
       <table  class="first" width="60%" border="3" cellspacing="1" bordercolor="#006600" height="200" ><tr><td>
	   <form name="login" action="logina.php" method="post" onSubmit="return val(this)">
	    <table width="100%" align="center" >
                <tr>
                  <td colspan="2"><div align="center"><font size="3" face="Verdana, Arial, Helvetica, sans-serif"><font color="FFFFFF" size="4" face="Arial, Helvetica, sans-serif">Welcome
                        to Accounts</font></font></div></td>
                </tr>
                <tr>
                  <td colspan="2" style="border-bottom: 1px dotted #006600;"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="FFFFFF">Login
