...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Cheque Tally Report"; ?>';
</script>
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="chequetally.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF" colspan="2">&nbsp;<strong>Get Cheque Tally Report</strong>                                 </td>
                                </tr>
...
<tr>
<td>
Select Type of Date <select id="typed" name="typed" >
       

<option value="voudate">Voucher Date</option>
<option value="chequeissue">Cheque Issue Date</option>
<option value="chequedate">Cheque Date</option>
<option value="chequereceiveddate">Cheque Received Date</option>
<option value="encashcdate">Cheque EnCashed Date</option>
...
<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Select Bank:<select id="acname_b" name="acname_b" >
   ...
   echo  "<option value=\"$array_acccode_b[$i]\">$array_acc_name_b[$i] - Our Account No $array_acccode_b[$i]</option>";
	...
	?>
		...
		<tr><td colspan="2" align="center"><input type="hidden" name="aa_name" id="aa_name" value="select"><input type="submit" name="ssubmit" value="Get  Cheque Tally Report" ></td></tr></table>
