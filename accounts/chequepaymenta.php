...
$s_saccode = $_POST["saccode"];  // Debiting Account Code
...
$petq ="insert into chequevou(typeofv, vounum, dbamt,cramt, paidto, description, voudate, chequeno, inw,chequeissue,chequedate,bankname,bank_acccode,debit_acccode,encashedbull) VALUES ('$s_voutype','$s_vouno',$s_amount,0,'$s_paidto','$s_beingp','$s_voudate',$s_refno,'$s_inw','$s_voudate2','$s_voudate1','$s_bankname','$s_bank_acccode','$s_accode','TRUE')";
...
$petqcr ="insert into pettyvou(typeofv, vounum, dbamt,cramt, recfrom, description, voudate, statementno, inw ) VALUES ('CR','$seq',0,$s_amount,'$s_paidto','$s_beingp','$s_voudate',$statementno_s,'$s_inw')";
