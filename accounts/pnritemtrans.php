...
$query_voc ="select voctype,vocno,vocdate,acccode,narration,dbamt,cramt,pnr,moredet,supp_inv from vocmast where invno=$s_minv and sinvno=$s_itno and sinvtype='$s_itt' order by vocno,voctype,vocsno";
...
$a_supp_inv[] = $rows_voc["supp_inv"];
	...
	?>
 <tr>
     <td bgcolor="#CCCCCC" colspan="8" align="center"><font size="3" face="Arial,Verdana,  Helvetica, sans-serif"><strong>CR & PV <?echo $s_minv ." - ". $s_itt ." - ". $s_itno;?> Transaction Summary </strong></font></td></tr>
