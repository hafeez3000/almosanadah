...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Cheque Payment Voucher"; ?>';
</script>
  ...
  <tr>
	...
	<table style="border: 1px solid red" width="100%" >
	 <tr>
                                  ...
                                  <td bgcolor="#FFDFDF">&nbsp;<strong>Cheque Payment Voucher</strong>                                 
								  <a href="printchequevou.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpayment" onClick="window.open('', 'pcashpayment','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif"  align="middle"></a>
								  
								  
								  &nbsp;&nbsp;<a href="printchequencb.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpayment" onClick="window.open('', 'pcashpayment','width=689,height=276,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/ncb.jpg" align="middle"></a>

  								  &nbsp;&nbsp;<a href="printchequencbn.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpaymentn" onClick="window.open('', 'pcashpaymentn','width=689,height=276,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/ncbn.jpg" align="middle"></a>

								  &nbsp;&nbsp;<a href="printchequencbnb.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpaymentnb" onClick="window.open('', 'pcashpaymentnb','width=750,height=276,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/ncbnb.jpg" align="middle"></a>
								  

&nbsp;&nbsp;<a href="printchequenbe.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpaymentnbe" onClick="window.open('', 'pcashpaymentnbe','width=750,height=276,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/nbe.jpg" align="middle"></a>

								<!--
								  &nbsp;&nbsp;<a href="printchequevou.php?voctype=<? echo $voc_t; ?>&vocnum=<?echo $voc_no ?>" target="pcashpayment" onClick="window.open('', 'pcashpayment','width=750,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/sabb.jpg" align="middle"></a>
                                   -->  
...
<tr><td>&nbsp;</td><td align="right" ><b>Cheque Amount SAR : <? echo $s_dbamt ;?>/-</b></td></tr>
	...
	<tr><td  style="border-bottom: 1px dashed red;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Paid to: <? echo $s_paidto ;?></font></td></tr>	
	...
	<tr><td  style="border-bottom: 1px dashed red;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>Being Paid: <? echo $s_description ;?></font></td></tr>		  


<tr><td  style="border-bottom: 1px dashed red;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>More Details:  <? echo $str_mored . $str_morec . " and Cheque Issued on : " . date('D, d-M-Y', strtotime($s_chequeissue)) ;?></font></td></tr>	
