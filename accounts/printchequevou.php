...
<table width="96%" border="0" cellpadding="0" cellspacing="1" >
	...
	<table style="border: 1px solid black" width="100%" cellpadding="3" cellspacing="2" >
	 ...
	 <tr>
      <td align="center"><font size="3" face="Arial,Verdana,Helvetica, sans-serif"><strong>Cheque Payment Voucher</strong></font>                                 <br></td>
     </tr>
...
<tr><td  style="border-bottom: 1px dashed black;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>More Details:  <? echo $str_mored . $str_morec . " and Cheque Issued on : " . date('D, d-M-Y', strtotime($s_chequeissue)) ;?></font></td></tr>	
