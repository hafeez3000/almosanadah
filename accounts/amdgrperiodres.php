...
<script>
document.title= '<? echo $company_name . " ERP - Umrah - Reservation Individual Rates Amend"; ?>';
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-bottom: 1px solid #999999 ;border-left: 3px solid #006600;border-right: 3px solid #006600"><tr>
    <td bgcolor="#CCCCCC"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;You 
      ...
      &raquo; IndividualRates Amend</font></td>
  </tr></table>
        ...
        <tr>
          <td valign="top"> 
			...
			<table cellpadding="0" cellspacing="0" width="100%" style="border-top: 1px solid #999999; border-bottom: 1px solid #999999"><tr>
                      <td bgcolor="#CCCCCC"><strong>Reservation Individual Rates Amend</strong></td>
                    </tr></table>
...
$query_g_rates ="select rate_sno,room_id,from_date,to_date,weekday_net,weekday_sell,weekend_net,weekend_sell,nationality,weekends,wpackage,breakfast,halfboard,fullboard,sahoor,iftar  from res_rates where from_date='$g_cin' and to_date='$g_cout' and nationality='$s_nation' and room_id like '$s_hotelsb%' order by room_id";
...
$arr_halfboard_rate[] = $rows_g_rates["halfboard"];
$arr_fullboard_rate[] = $rows_g_rates["fullboard"];
$arr_sahoor_rate[] = $rows_g_rates["sahoor"];
$arr_iftar_rate[] = $rows_g_rates["iftar"];
...
$_SESSION['a_rate_sno'] =$arr_rate_sno;
$_SESSION['a_rate_id'] =$arr_room_id;

$_SESSION['c_room_id'] = $array_room_id;
...
if(substr($arr_weekends[0],0,3)=="Tue"){
$wetu = "checked";
}
...
if($arr_wpackage[$ad]=="t"){ $package="Yes" ; } else { $package="No" ; }


echo "<tr><td colspan=\"5\" align=\"center\"><font size=\"1\" face=\"Verdana, Arial, Helvetica, sans-serif\">B/B:$arr_breakfast[$ad] | H/B:$arr_halfboard_rate[$ad] | F/B:$arr_fullboard_rate[$ad] | Sahoor:$arr_sahoor_rate[$ad] | Iftar:$arr_iftar_rate[$ad] | WeekEnds: $arr_weekends[$ad] | WE.Package: $package</font></td></tr>";
...
echo "<a href=\"#\" onmouseout=\"popUp(event,'WDN.$arr_weekday_net[$av]')\" onmouseover=\"popUp(event,'WDN.$arr_weekday_net[$av]')\" onclick=\"return false\">"; 
...
echo "<a href=\"#\" onmouseout=\"popUp(event,'WEN.$arr_weekend_net[$av]')\" onmouseover=\"popUp(event,'WEN.$arr_weekend_net[$av]')\" onclick=\"return false\">";
...
?>
                          <form name="gquot" action="amdgrperiodresa.php"  method="post" onSubmit="return fun2(this)">
                            <tr> 
                              <td colspan="5">&nbsp;</td>
                            </tr>
                            <tr bgcolor="#CCCCCC"> 
  ...
  echo  "<tr><td style=\"border-bottom: 1px solid #999999;\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">$array_rooms[$i]</font></td><td style=\"border-bottom: 1px solid #999999;\" align=\"center\"> <input type=\"text\" id=\"weekdayn$array_room_id[$i]\" name=\"weekdayn$array_room_id[$i]\" size=\"1\" value=\"$arr_weekday_net[$i]\"><INPUT TYPE=\"button\"  id=\"weekdaynb$array_room_id[$i]\" name=\"weekdaynb$array_room_id[$i]\" VALUE=\"+\" onClick=\"add$array_room_id[$i]()\" >&nbsp;<input type=\"text\" id=\"weekdays$array_room_id[$i]\" name=\"weekdays$array_room_id[$i]\" size=\"1\" value=\"$arr_weekday_sell[$i]\"><INPUT TYPE=\"button\"  id=\"weekdaysb$array_room_id[$i]\" name=\"weekdaysb$array_room_id[$i]\" VALUE=\"c\" onClick=\"caln$array_room_id[$i]()\" ></td><td align=\"center\" style=\"border-bottom: 1px solid #999999;\"><input type=\"text\" id=\"weekendn$array_room_id[$i]\" name=\"weekendn$array_room_id[$i]\" size=\"1\" value=\"$arr_weekend_net[$i]\"><INPUT TYPE=\"button\"  id=\"weekendnb$array_room_id[$i]\" name=\"weekendnb$array_room_id[$i]\" VALUE=\"+\" onClick=\"adde$array_room_id[$i]()\" >&nbsp;<input type=\"text\" id=\"weekends$array_room_id[$i]\" name=\"weekends$array_room_id[$i]\" size=\"1\" value=\"$arr_weekend_sell[$i]\"><INPUT TYPE=\"button\"  id=\"weekendsb$array_room_id[$i]\" name=\"weekendsb$array_room_id[$i]\" VALUE=\"c\" onClick=\"calne$array_room_id[$i]()\" ></td></tr>";
...
document.getElementById('Submit').disabled=true;
                            ...
                            <td colspan="5">Nationality:      <select id="scountry" name="scountry[]" multiple size=3 onChange="getnat();">
                              <option value="<?php echo $arr_nationality_s[0]; ?>"  selected ><?php echo $arr_nationality_s[0]; ?></option>
...
document.getElementById('scou').value = selva.substr(0,selva.length-2);
						...
						<tr>
						<td colspan="5"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">WeekEnds Rates( Tue,Wed,Thu or Wed,Thu): Tue<input type="checkbox" id="wetue" name="wetue" <? echo $wetu ;?>  > | Wed<input type="checkbox" id="wewed" name="wewed" checked >| Thu<input type="checkbox" id="wethu" name="wethu" checked >| Fri<input type="checkbox" id="wefri" name="wefri" checked >&nbsp;&nbsp;WeekEnd Pacakage  <input type="checkbox" id="wep" name="wep" <? echo $wepc ;?>  ></font></td>
						</tr>
...
<input type="hidden" name="g_hot" value='<? echo $s_hotelsb1 ;?>'>
                                 ...
                                 <input type="checkbox" id="inscb" name="inscb" unchecked onClick="sameas();" onBlur="sameas();" onFocus="sameas();"><input type="submit" id="Submit" name="Submit" value="Amend Hotel Rates >>" disabled></td>
                            </tr>
                          </form>
                        </table>
                         </td>
...
<script>
   ...
   if (dvy < 2000) dvy += 1900;	
	...
	var now_year1 = now_date1.getFullYear();
