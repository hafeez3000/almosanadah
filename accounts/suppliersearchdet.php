...
echo "<td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">" .ucwords(strtolower($rows_trans["supp_name"])) . "</font></td>";
echo "<td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . ucwords(strtolower($rows_trans["city"])) . "</font></td>";

echo "<td><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">" .$rows_trans["contact_p_title"].".".ucwords(strtolower($rows_trans["contact_p_name"])). "</font></td>";
