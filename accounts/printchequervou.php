...
?>
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Print Cheque Receipt Voucher"; ?>';
</script>
...
<table width="96%" border="0" cellpadding="0" cellspacing="1" >
	...
	<table style="border: 1px solid black" width="100%" cellpadding="3" cellspacing="2" >
	 ...
	 <tr>
      <td align="center"><font size="3" face="Arial,Verdana,Helvetica, sans-serif"><strong>Cheque Receipt Voucher</strong></font>                                 <br></td>
     </tr>
   ...
   <td align="right">
	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Cheque No: <? echo $s_chequeno ;?></font> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> & Cheque Date: <? echo $vd = date('d-M-Y', strtotime($s_chequedate)); ?></font> </td>
	</tr>
...
<tr><td>&nbsp;</td><td align="right" ><b>Cheque Amount SAR : <? echo $s_dbamt ;?>/-</b></td></tr>
	...
	<tr><td  style="border-bottom: 1px dashed black;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Received From: <? echo $s_paidto ;?></font></td></tr>	
	...
	<tr><td  style="border-bottom: 1px dashed black;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>Paid For: <? echo $s_description ;?></font></td></tr>		  

<tr><td  style="border-bottom: 1px dashed black;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>More Details:  <? echo $str_mored . $str_morec . " and Cheque Received on : " . date('D, d-M-Y', strtotime($s_chequeissue)) ;?></font></td></tr>	
