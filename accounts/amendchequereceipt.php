...
$q_hotel_sel ="select voctype, vocno,acccode  from vocmast where voctype='$voc_t' and vocno='$voc_no'  and dbamt=0";
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="amendchequereceipta.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF">&nbsp;<strong>New Cheque Receipt Voucher</strong>                                 </td>
                                </tr>
   ...
   <tr> 
      ...
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
        <select name="dYear" class="selBox">
		   ...
		   <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp; Received Date</font></td>
      <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
	...
	<tr><td >  <font size="2" face="Verdana, Arial, Helvetica, sans-serif">&nbsp;Cheque Date</font>
...
<script type="text/javascript">
          ...
          if ((document.selhotel.saccode.value== null) || ((document.selhotel.saccode.value).length==0))
   {
	  ...
	  <td style="border-top: 1px solid red"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> Enter A/c Code : <input type="text" id="accode" name="accode" value="<? echo $acccode_s ; ?>"size="2" onKeyUp="acc()"  onFocus="acc()" onBlur="acc()">
  ...
  <tr><td>
		<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Bank Name & Branch</font> <input type="text" id="bankname" name="bankname" size="70" value="<? echo $s_bankname; ?>" >
	...
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Received <br>From:&nbsp;&nbsp;</font> <input type="text" id="paidto" name="paidto" size="85" value="<? echo $s_recfrom ?>" >	  </td></tr>	
	
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">For :&nbsp;&nbsp;&nbsp; </font> <textarea id="beingp" name="beingp" cols="65" rows="3" ><? echo $s_description; ?></textarea>	  </td></tr>	  
...
function TryVal() {
  ...
  TryNo %= Tries.length }
	...
	<tr><td><br><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Amount:</font> <input type="text" id="camt" name="camt"  value="<? echo $s_cramt; ?>"  size="5" onKeyUp="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }" onFocus="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }" onBlur="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }">	  /-</td></tr>	
	...
	<tr> 
	  ...
	  <tr>
<td style="border-top: 1px solid red"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Select Submiting/Debiting Account:<select id="acname_b" name="acname_b" >
       
        <?


for($i=0;$i<count($array_acccode);$i++){
if($s_bank_acccode==$array_acccode[$i]){
  echo  "<option value=\"$array_acccode[$i]\">$array_acc_name[$i] - $array_acccode[$i]</option>";
}
}
		for($i=0;$i<count($array_acccode);$i++){
...
alert("Sorry, But Enter the Cheque Number");
return false;
}
...
alert("Sorry, But Enter the Crediting account code");
return false;
}
...
alert("Sorry, But Enter the details from whom you are receiving");
return false;
}
...
if((document.getElementById('acname_b').value)=="select"){
document.getElementById('accode_b').focus();
alert("Sorry, But Enter the Debiting account code");
return false;
}
