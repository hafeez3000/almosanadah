...
$_SESSION['hotelrates_entry'] = $s_hotelsb;
}


if($s_hotelsb==""){
$s_hotelsb = $_SESSION['hotelrates_entry'];
}
...
if($_POST["wefri"]=="on"){ $s_weekends = $s_weekends . "Fri," ;}
...
?>
                          <form name="gquot" id="gquot"  action="<?php echo $_SERVER['PHP_SELF']; ?>"  method="post" onSubmit="return fun2(this)">
                            <tr>
                              <td colspan="5">&nbsp;</td>
                            </tr>
                            <tr bgcolor="#CCCCCC">
...
document.getElementById('scou').value = selva.substr(0,selva.length-2);
						...
						<td colspan="5"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">WeekEnds Rates( Tue,Wed,Thu or Wed,Thu): Tue<input type="checkbox" id="wetue" name="wetue" <? echo $wetu ;?>  > | Wed<input type="checkbox" id="wewed" name="wewed" checked >| Thu<input type="checkbox" id="wethu" name="wethu" checked >| Fri<input type="checkbox" id="wefri" name="wefri" checked >&nbsp;&nbsp;WeekEnd Pacakage  <input type="checkbox" id="wep" name="wep" <? echo $wepc ;?>  ></font></td>
                            ...
                            <tr>
                              <td colspan="5"  align="right"> <input type="hidden" id="action" name="action" value="unsubmitted" />
...
<script>
	...
	initDates(now_year-3, now_year+10, now_year, now_month, now_day, d1);


   	var d2 = new dateObj(document.gquot.d1Day, document.gquot.d1Month, document.gquot.d1Year);
	initDates(now_year1-3, now_year1+10, now_year1, now_month1, now_day1, d2);
...
if(document.getElementById("inscb").checked == true){
    ...
    var form = document.getElementById("gquot");
    form.submit();
