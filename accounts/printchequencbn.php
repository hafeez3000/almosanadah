...
body {background-image: url("../images/ncbnewchd.jpg") ;   background-repeat: no-repeat; }
...
<table height="276" width="689" border="0" cellpadding="0" cellspacing="0" >
   ...
   <td align="right" height="18" valign="top">
	<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $vd = date('d-M-Y', strtotime($s_chequedate)); ?>
   ...
   <td align="right" height="20" valign="top">
	<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Jeddah
...
<br><br>
 ...
 <tr>
	  <td><table align="center" width="530" border="0" >
	...
	?>
			<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $s_paidto ;?></font></td>
	...
	<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $s_inw ;?></font></td>
	
	<td align="right"><font size="2" face="Arial, Verdana, Helvetica, sans-serif"><b><? echo "SAR#".number_format($s_dbamt, 2, "." , ",") ;?>/-</b> </font>
    ...
    <table width="689"  cellpadding="2" cellspacing="1">
	<tr><td>
			<? for($i=0; $i<5; $i++){
	echo "&nbsp;"; 
	}
	...
	<font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $s_description ;?></font>
	</td></tr>		  	
	</table>
