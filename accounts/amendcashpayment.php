...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Amend Cash Payment Voucher"; ?>';
</script>
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="amendcashpaymenta.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF">&nbsp;<strong>Amend Cash Payment Voucher</strong>                                 </td>
                                </tr>
   ...
   <tr> 
	...
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Paid to:</font> <input type="text" id="paidto" name="paidto" size="85" value="<? echo $s_paidto ;?>">	  </td></tr>	
...
function TryVal() {
  ...
  TryNo %= Tries.length }
	...
	<tr> 
            ...
            <td>In words:<input type="text" id="inw" name="inw" size="80"></td>
          </tr>
