...
<script>
document.title= '<? echo $company_name . " ERP - Acounts - Get Profit and Loss for ... "; ?>';
</script>
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="pl.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF" colspan="2">&nbsp;<strong>Get Profit and Loss for ... </strong>                                 </td>
                                </tr>
	  ...
	  <td colspan="2"><table align="left">
        <tr>
          ...
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            ...
            </select> &nbsp;With Opening Balance <input type="checkbox" id="withob" name="withob" >
          </font></td>
        </tr>
      </table></td>
	  </tr>
	
		<tr><td colspan="2" align="center"><input type="hidden" name="aa_name" id="aa_name" value="select"><input type="submit" name="ssubmit" value="Get Profit and Loss" ></td></tr></table>
