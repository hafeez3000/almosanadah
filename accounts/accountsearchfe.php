...
<?
echo "<table width=\"98%\" border=\"1\"  cellspacing=\"0\"><thead style=\"display:table-header-group;\"><tr><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Sel</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">OK</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A/C Code</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Account Name</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Account Desc</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Account Type</font></td><td style=\"border-bottom: 1px solid #999999\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Parent Account</font></td></tr></thead>";
...
//    opener.document.selhotel.accode.focus();
 ...
 opener.document.getElementById('txtRow'+<? echo $btt ; ?>).value = document.childForm.tems.value;
//    opener.document.selhotel.accode.focus();
opener.document.getElementById('txtRow'+<? echo $btt ; ?>).focus();
...
opener.document.getElementById('txtRow'+<? echo $btt ; ?>).value = document.childForm.tems[i].value;
//    opener.document.selhotel.accode.focus();
opener.document.getElementById('txtRow'+<? echo $btt ; ?>).focus();
 	self.close();
	return false;
