...
?>
		  ...
		  &nbsp;&nbsp;
		   ...
		   <a href="printtbsagents.php?wz=<? echo $wz ?>&fd=<? echo $fromd ?>&td=<? echo $tod ?>&acc=<? echo $accn ?>&accn=<? echo $aa_name ?>" target="ptbs" onClick="window.open('', 'ptbs','width=760,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16"></a>

		&nbsp;&nbsp;

      <img src="../images/email.jpg"  onClick="ppg()">
...
<script>
function ppg(){
window.open('sendemailagents.php?fd=<? echo $fromd ?>&td=<? echo $tod ?>', 'printplgraph','width=750,height=300,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus();
}
</script>
