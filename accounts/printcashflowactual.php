...
$accn_s="";
$accn_qt="";
if($accn=="payments") { $accn_qt="where cast(acccode as integer) between 400000 and 500000" ; $accn_s="<br>Hotel & Supplier Payments"; $wzs="<br>With Credit Balance Only" ;} else { $accn_qt="where cast(acccode as integer) between 150000 and 399999" ; $accn_s="<br>Agents Receivables"; $wzs="<br>With Debit Balance Only" ;}  
...
<tr> 
      ...
      <td   align="center"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total Credit</font></div></td>
    <tr> 
</thead>
...
if($z_check==1){  // if zero check
      ...
      echo "<td style=\"border-top: 1px solid black\"><div align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">" . number_format(round(($ctotcr*100/100),2), 2, "." , ",") . "</font></div></td>";
...
<tr>
<td colspan="3"  style="border-top: 1px solid black;border-right: 1px solid black"><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total</font></div></td>


<td style="border-top: 1px solid black"><div align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><? echo number_format($gbalcr, 2, "." , ",") ?></strong></font></div></td>
</tr>
