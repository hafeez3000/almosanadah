...
class Tree
{
   ...
   //     $connection = pg_connect("host=localhost port=5432 dbname=dorserp user=dorserp password=dors"); 

       $query_acc = "select acccode as id, parent_acc as parent_id, acc_name as text , lpad(acccode,15,'gac.php?=') as link from accmast ORDER BY parent_id, id";
