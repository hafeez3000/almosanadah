  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="chequereceipta.php" onSubmit="return fun2(this)">
	...
	<tr>
	  <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Voucher Type</font>
	    ...
	    &nbsp;&nbsp;<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Voucher No</font><input type="text" id="vouno" name="vouno" value=<? echo $seq ?> size="10" >   
...
<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Cheque No</font> <input type="text" id="refno" name="refno" size="6" >
...
<script type="text/javascript">
  ...
  <tr><td>
		<font size="2" face="Verdana, Arial, Helvetica, sans-serif">Bank Name & Branch</font> <input type="text" id="bankname" name="bankname" size="70" >
	...
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Received <br>From:&nbsp;&nbsp;</font> <input type="text" id="paidto" name="paidto" size="85" >	  </td></tr>	
	
	<tr><td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">For :&nbsp;&nbsp;&nbsp; </font> <textarea id="beingp" name="beingp" cols="65" rows="3" ></textarea>	  </td></tr>	  
...
function TryVal() {
  ...
  TryNo %= Tries.length }
	...
	<tr><td><br><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Amount:</font> <input type="text" id="camt" name="camt" value="0" size="5" onKeyUp="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }" onFocus="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }" onBlur="if (regular(this.value)) { DoIt() } else { alert('Not Valid') }">	  /-</td></tr>	
