  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="query.php" onSubmit="return fun2(this)">
	
	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF" colspan="2">&nbsp;<strong>Get Query Results for ... </strong>                                 </td>
                                </tr>
...
for($i=0; $i<count($array_acc_name); $i++){
   ...
   echo  "<option value=\"$array_voctype[$i]\">$array_ename[$i] - $array_voctype[$i]</option>";
	...
	?>
		...
		<tr><td colspan="2" align="center"><input type="hidden" name="aa_name" id="aa_name" value="select"><input type="submit" name="ssubmit" value="Get Transactions of Query" ></td></tr></table>
