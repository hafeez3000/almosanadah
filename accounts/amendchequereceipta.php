...
$petq ="update chequevou set dbamt=0,cramt=$s_amount, recfrom='$s_paidto', description='$s_beingp', voudate='$s_voudate', chequeno='$s_refno', inw='$s_inw',chequeissue='$s_voudate2',chequedate='$s_voudate1',bankname='$s_bankname',bank_acccode='$s_bank_acccode',debit_acccode='$s_accode',encashedbull='TRUE' where typeofv='$s_voutype' and vounum='$s_vouno'";  
...
$insq = "update vocmast set vocdate='$s_voudate',acccode='$s_bank_acccode',narration='$s_paidto',moredet='$s_beingp',dbamt=$s_amount,cramt=0,recon='f' where voctype='$s_voutype' and vocno='$s_vouno' and acccode='$bank_c' ";

pg_query($conn, $insq);

$insq2 = "update vocmast set vocdate='$s_voudate',acccode='$s_accode',narration='$s_paidto',moredet='$s_beingp',dbamt=0,cramt=$s_amount,recon='f' where voctype='$s_voutype' and vocno='$s_vouno' and acccode='$a_acccode'";
...
$insq = "insert into vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,moredet,dbamt,cramt,recon) values('$s_voutype','$s_vouno',1,'$s_voudate','$s_bank_acccode','$s_paidto','$s_beingp',$s_amount,0,'f')";

pg_query($conn, $insq);

$insq2 = "insert into vocmast(voctype,vocno,vocsno,vocdate,acccode,narration,moredet,dbamt,cramt,recon) values('$s_voutype','$s_vouno',2,'$s_voudate','$s_accode','$s_paidto','$s_beingp',0,$s_amount,'f')";
