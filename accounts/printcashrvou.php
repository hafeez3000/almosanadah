...
<table width="96%" border="0" cellpadding="0" cellspacing="1" >
	...
	<table style="border: 1px solid black" width="100%" cellpadding="3" cellspacing="2" >
	 ...
	 <tr>
      <td align="center"><font size="3" face="Arial,Verdana,Helvetica, sans-serif"><strong>Cash Receipt Voucher</strong></font>                                 <br></td>
     </tr>
...
<tr><td>&nbsp;</td><td align="right" ><b>Cash Amount SAR : <? echo $s_dbamt ;?>/-</b></td></tr>
	...
	<tr><td  style="border-bottom: 1px dashed black;" ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><br>For: <? echo $s_description ;?></font></td></tr>		  
