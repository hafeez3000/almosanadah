...
$query_hotel_b ="select acccode,acc_name from accmast where parent_acc='101001' ORDER BY acccode";
  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="chequepaymenta.php" onSubmit="return fun2(this)">

	<table style="border: 1px solid red" width="100%" >
	 <tr>

                                  <td bgcolor="#FFDFDF">&nbsp;<strong>New Cheque Payment Voucher</strong>                                 </td>
                                </tr>
...
<tr>
<td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Select Bank:<select id="acname_b" name="acname_b" >
...
<script type="text/javascript">
          ...
          if ((document.selhotel.saccode.value== null) || ((document.selhotel.saccode.value).length==0))
   {
	  ...
	  <td ><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> Enter A/c Code : <input type="text" id="accode" name="accode" size="2" onKeyUp="acc()"  onFocus="acc()" onBlur="acc()">
