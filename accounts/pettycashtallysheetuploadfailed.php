...
<a href="printpettycash.php?statement_no=<? echo $statementno_s ?>" target="ppc" onClick="window.open('', 'ppc','width=760,height=450,menubar=yes,scrollbars=yes, top='+wint+',left='+winl+' ').focus()"><img src="../images/print_icon.gif" width="16" height="16"></a>
	...
	<table style="border: 1px solid red" width="100%"  border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
                                  <td colspan="6" align="center" style="border-bottom: 1px solid red">&nbsp;<strong>Current Petty Cash Tally Sheet</strong>                                 </td>
...
<tr><td style="border-top: 1px solid red;border-right: 1px solid red" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">S.No</font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Date</font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Voucher</font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Paticulars</font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Debit</font></td><td style="border-top: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" >Credit</font></td></tr>


<tr><td style="border-top: 1px solid red;border-right: 1px solid red" align="center" colspan="4"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Cash in Hand on Dated: <? echo $cd = date('D, d-M-Y', strtotime($closingdate_s));  ?></font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? $opb = $openingamount_s; echo $opb = number_format($opb, 2, "." , ","); ?></font></td><td style="border-top: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" >0.00</font></td></tr>
...
$query_voc ="select typeofv,vounum,paidto,dbamt,cramt,voudate,recfrom,statementno,amendbull from pettyvou where statementno='$statementno_s' order by vounum,cramt";
...
echo "</font></td><td style=\"border-top: 1px solid red;border-right: 1px solid red\" align=\"left\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\" >$pati</font></td><td style=\"border-top: 1px solid red;border-right: 1px solid red\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\" >$cra</font></td><td style=\"border-top: 1px solid red\" align=\"right\"><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\" >$dba</font></td></tr>";

}
	
?>

<tr><td style="border-top: 1px solid red;border-right: 1px solid red" colspan="4" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Total in SAR</font></td><td style="border-top: 1px solid red;border-right: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><? echo number_format($totcr, 2, "." , ",") ?></b></font></td><td style="border-top: 1px solid red" align="right"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><? echo number_format($totdb, 2, "." , ","); ?></b></font></td></tr>

<tr><td style="border-top: 1px solid red" colspan="6" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b>Current Petty Cash in Hand : SAR <? echo number_format(($totcr-$totdb), 2, "." , ","); ?>/- </b></font></td></tr>
