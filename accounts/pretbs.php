  ...
  <tr>
    ...
    <td width="80%" valign="top"  > <table width="100%" border="0" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <form name="selhotel" method="post" action="tbs.php" onSubmit="return fun2(this)">
	  ...
	  <td colspan="2"><table align="left">
        <tr>
          ...
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="dDay" id="dDay" class="selBox">
            </select>
          </font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="dMonth" id="dMonth" class="selBox">
            </select>
          </font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="dYear" id="dYear" class="selBox">
            </select>
          </font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">To Date&nbsp;</font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="d1Day" id="d1Day"  class="selBox">
            </select>
          </font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="d1Month" id="d1Month" class="selBox">
            </select>
          </font></td>
          <td><font size="2" face="Verdana, Arial, Helvetica, sans-serif">
            <select name="d1Year" id="d1Year" class="selBox">
            </select>
          </font></td>
        </tr>
      </table></td>
   ...
   echo  "<option value=\"$key\">$value - $key</option>";
	...
	?>
	  ...
	  function etoexcel(){
		    //alert("asdf");  $fromd = $madciny ."-". $madcinm ."-". $madcind ; 
		   document.location.href = 'tbs_export.php?fromd='+document.getElementById("dYear").value+'-'+document.getElementById("dMonth").value+'-'+document.getElementById("dDay").value+'&tod='+document.getElementById("d1Year").value+'-'+document.getElementById("d1Month").value+'-'+document.getElementById("d1Day").value+'&acname='+document.getElementById("acname").value+'&wch='+document.getElementById("withz").checked;
		   //+document.getElementById("dDay").value
		//document.location.href=ag_vn ;	
		
		// newwindow=window.open(ag_vn,'myPopup','height=400,width=600 top='+wint+',left='+winl+' ');
	  // if (window.focus) {newwindow.focus();}
		...
		<tr><td colspan="1" align="center"><input type="hidden" name="aa_name" id="aa_name" value="select"><input type="submit" name="ssubmit" value="Get Trial Balance" ></td><td colspan="1" align="center"><input type="hidden" name="aa_name" id="aa_name" value="select"> 
    <input type="button" name="ebutton" value="Export Trial Balance to Excel" onclick="etoexcel();"></td></tr></table>
