...
<form name="selhotel" method="post" action="transdetailsamend.php" >

<?	


$hotel_id = trim(isset($_POST['hotelv']) ? $_POST['hotelv'] : '');
...
pg_free_result($result_hotel);
 ...
 <input type="submit" name="submit" id="submit" value="Amend Trasportation Supplier Details">									  
	</form>		
