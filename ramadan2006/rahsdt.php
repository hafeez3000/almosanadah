<html>
<head><title>HS - Dar Al Tawhid</title></head>
<body>
<center>
  <strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Hotel : 
  Dar Al Tawhid</font></strong> 
...
$query  = "SELECT ocode,cin, cout, no_rooms, guest_occ_status, cus_paid from sales_hotels where cout between  date '$tod' - integer '30'  and '$tod' and cout > '$fromd' and ocode!='NA' and hotel_id='$hotelid' and booking_status!='Cancelled' or  cin  between '$fromd' and '$tod' and ocode!='NA' and hotel_id='$hotelid' and booking_status!='Cancelled' or   cin between date '$tod' - integer '30' and '$tod' and  cout > '$tod' and ocode!='NA' and hotel_id='$hotelid' and booking_status!='Cancelled' order by cin";
...
$p=0;
for ($ja=0; $ja < $df ; $ja++) {
$querya = "select sum(allotment) as allotments from rates11101 where rate_date between date '$fromd' + integer '$ja'  and date '$fromd' + integer '$ja'  and room_id like '11101%' ";
...
{  
	...
	?>
      <td> <div align="center"><strong><font color="#0000FF" size="2" face="Arial, Helvetica, sans-serif"><? echo $rowa["allotments"]; $allot[$p] = $rowa["allotments"];?> 
         </font></strong></div></td>
      <?	
$p++;
	}
